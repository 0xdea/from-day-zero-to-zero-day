  ...
  if ( Var )
  {
    ...
    while ( v1 < v2 )
    {
      ...
      *v7 = 0;
      ...
      v17 = 0;
      eval(&v12, 0, 0, 0);
      if ( *(_BYTE *)sub_E670("lan1_ifname") )
      {
        v15 = sub_E670("lan1_ifname");
        v12 = "ether-wake";
        v13 = "-b";
        v14 = "-i";
        v16 = v4;
      ...
      if ( *(_BYTE *)sub_E670("lan2_ifname") )
      {
        v15 = sub_E670("lan2_ifname");
        v12 = "ether-wake";
        v13 = "-b";
        v14 = "-i";
        v16 = v4;
      ...
      if ( *(_BYTE *)sub_E670("lan3_ifname") )
      {
        v15 = sub_E670("lan3_ifname");
        v12 = "ether-wake";
        v13 = "-b";
        v14 = "-i";
        v16 = v4;
