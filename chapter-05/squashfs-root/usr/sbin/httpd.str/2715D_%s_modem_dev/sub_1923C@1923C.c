const char *__fastcall sub_1923C(const char *a1)
{
  ...
  if ( is_value_in_nvram_1((int)v4, "ppp3g") )
    goto LABEL_6;
  if ( !is_value_in_nvram_1((int)v4, "lte") )
  {
    v3 = "\nwwansms_error = 'WAN is not WWAN!'";
    goto LABEL_11;
  }
  snprintf(v4, 0x20u, "%s_modem_type", a1);
  if ( !is_value_in_nvram_1((int)v4, "non-hilink")
    && !is_value_in_nvram_1((int)v4, "huawei-non-hilink")
    && !is_value_in_nvram_1((int)v4, "hw-ether") )
  {
