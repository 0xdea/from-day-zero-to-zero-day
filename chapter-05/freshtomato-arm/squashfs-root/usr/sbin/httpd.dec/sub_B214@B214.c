void sub_B214(int a1, ...)
{
  ...
  int v3; // r5
  int v4; // r0
  int v5; // [sp+24h] [bp-Ch] BYREF
  va_list va; // [sp+24h] [bp-Ch]
  int v7; // [sp+28h] [bp-8h]
  int v8; // [sp+2Ch] [bp-4h]
  int v9; // [sp+30h] [bp+0h]
  int v10; // [sp+34h] [bp+4h]
  int v11; // [sp+38h] [bp+8h] BYREF
  int v12; // [sp+3Ch] [bp+Ch]
  int v13; // [sp+40h] [bp+10h]
  int v14; // [sp+44h] [bp+14h]
  int v15; // [sp+48h] [bp+18h]
  int v16; // [sp+4Ch] [bp+1Ch]
  int v17; // [sp+50h] [bp+20h]
  int v18; // [sp+54h] [bp+24h]
  int v19; // [sp+58h] [bp+28h]
  int v20; // [sp+5Ch] [bp+2Ch]
  int v21; // [sp+60h] [bp+30h]
  int v22; // [sp+64h] [bp+34h]
  int v23; // [sp+68h] [bp+38h]
  int v24; // [sp+6Ch] [bp+3Ch]
  ...
  if ( check_wanup() )
  {
    wanfaces = (const void *)get_wanfaces();
    v3 = 0;
    ...
    while ( v3 < v5 )
    {
      if ( v1[21] )
      {
        if ( strcmp((const char *)&v11 + 34 * v3 + 1, "0.0.0.0") )
        {
          v4 = nvram_get_int("remote_mgt_https");
          sub_AF6C((const char *)&v11 + 34 * v3 + 1, v24, 0, v4);
        }
      }
      ++v3;
      v1 += 34;
