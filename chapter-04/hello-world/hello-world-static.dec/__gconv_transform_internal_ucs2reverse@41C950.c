        ...
        unsigned int a8)
{
  ...
  __int64 (__fastcall *v93)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD); // [xsp+18h] [xbp-68h]
  ...
  if ( a8 )
  {
    ...
    if ( v25 )
    {
      ...
      if ( a4 < (unsigned __int64)v26 - v30 + 4 )
      {
        *v22 = (unsigned int *)a4;
        v71 = a4 - (_QWORD)v26 + v30;
        if ( v71 > 4 )
        {
          _libc_assert_fail(
...
LABEL_141:
    ...
    v89 = v24;
    v91 = v15;
    v93 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))v20;
    v95 = v19;
    v97 = v13;
    v99 = v33;
    v100 = v14;
