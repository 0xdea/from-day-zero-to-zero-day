        ...
        char a12)
{
  ...
  __int64 v105; // x22
  _BYTE *v106; // x19
  __int64 v107; // [xsp+0h] [xbp-920h]
  __int64 v108; // [xsp+0h] [xbp-920h]
  __int64 v109; // [xsp+0h] [xbp-920h]
  __int64 v111; // [xsp+18h] [xbp-908h]
  _BYTE *v112; // [xsp+18h] [xbp-908h]
  __int64 v113; // [xsp+18h] [xbp-908h]
  __int64 v114; // [xsp+18h] [xbp-908h]
  unsigned __int64 v116; // [xsp+38h] [xbp-8E8h]
  _BYTE *v117; // [xsp+40h] [xbp-8E0h]
  __int64 v118; // [xsp+50h] [xbp-8D0h]
  __int64 v119; // [xsp+58h] [xbp-8C8h]
  unsigned __int64 v120; // [xsp+B8h] [xbp-868h] BYREF
  __int64 v121; // [xsp+C0h] [xbp-860h] BYREF
  _BYTE *v122; // [xsp+E0h] [xbp-840h] BYREF
  unsigned __int64 v123; // [xsp+E8h] [xbp-838h]
  _BYTE v124[784]; // [xsp+F0h] [xbp-830h] BYREF
  __int64 v125; // [xsp+400h] [xbp-520h]
  _BYTE *v126; // [xsp+4F0h] [xbp-430h] BYREF
  __int64 v127; // [xsp+4F8h] [xbp-428h]
  _BYTE v128[1032]; // [xsp+500h] [xbp-420h] BYREF
  _BYTE v129[4]; // [xsp+914h] [xbp-Ch] BYREF
  ...
  if ( *a7 )
  {
    ...
    while ( 1 )
    {
      v18 += _parse_one_specmb(v16, v18, &v14[72 * v17], &v120, &v121);
      if ( (v121 & 1) != 0 )
        goto LABEL_10;
      ...
      if ( v15 == v17 )
      {
        if ( (_libc_scratch_buffer_grow_preserve(&v122) & 1) == 0 )
          goto LABEL_10;
        v14 = v122;
        v15 = v123 / 0x48;
      }
...
LABEL_109:
      if ( _printf_va_arg_table && *(_QWORD *)(_printf_va_arg_table + 8LL * v51 - 64) )
      {
        v103 = (int *)&v30[v52];
        if ( &v126[v127] < &v117[*(int *)&v30[4 * v50]] )
        {
          do
          {
            v108 = v33;
            v113 = v49;
            v105 = v117 - &v31[v33];
            if ( (_libc_scratch_buffer_grow_preserve(&v126) & 1) == 0 )
              goto LABEL_10;
            v33 = v108;
            v104 = v108 + v105;
            v34 = (__int64)v126;
            v30 = &v126[v118];
            v31 = &v126[v118 + v108];
            v103 = (int *)&v126[v118 + v52];
            v117 = &v31[v104];
            v49 = v113;
          }
          while ( &v31[v104 + *(int *)&v126[4 * v50 + v118]] > &v126[v127] );
        }
        *(_QWORD *)(v34 + v49) = v117;
        v109 = v34;
        v114 = v49;
        v119 = v33;
        v106 = &v117[*v103];
        (*(void (**)(void))(_printf_va_arg_table + 8LL * *(int *)&v31[4 * v50] - 64))();
        v117 = v106;
        v34 = v109;
        v49 = v114;
        v33 = v119;
...
LABEL_26:
    ...
    v48 = *((int *)v35 + 12);
    v35 += 72;
    (*(void (__fastcall **)(_BYTE *, __int64, _BYTE *, _BYTE *))(_printf_arginfo_table + 8 * v47))(
      v46,
      v45,
      &v39[4 * v48],
      &v37[4 * v48]);
...
LABEL_56:
  ...
  if ( a6 < v17 )
  {
    ...
    do
    {
      ...
      {
        v69 = *(_QWORD *)(_printf_function_table + 8LL * (unsigned __int8)v64);
        if ( v69 )
        {
          v61 = _printf_function_invoke(a1, v69, v59 + 16LL * v60[12], *((_QWORD *)v60 + 7), v60);
          if ( v61 != -2 )
          {
            if ( v61 < 0 )
              goto LABEL_10;
...
LABEL_78:
      ...
      if ( v73 )
      {
        v97 = (_BYTE *)itoa_word(v73, (__int64)v129, 0xAu, 0);
        if ( v97 < v129 )
        {
          do
          {
      ...
      if ( *v60 != -1 )
      {
        ...
        v75 = (_BYTE *)itoa_word(*v60, (__int64)v129, 0xAu, 0);
        if ( v75 < v129 )
        {
          do
          {
      ...
      if ( v60[2] )
      {
        ...
        if ( v94 == *(_BYTE **)(a1 + 16) )
        {
          _printf_buffer_putc_1(a1, (unsigned __int8)v60[2]);
        }
        else
        {
          *(_QWORD *)(a1 + 8) = v94 + 1;
...
LABEL_60:
      ...
      ++v57;
      v60 += 18;
      _printf_buffer_write(a1, v62, v63 - v62);
    }
    while ( v116 > v57 );
  }
LABEL_11:
  if ( v126 != v128 )
    free((__int64)v126, *(double *)&v19, v20, v21, v22, v23, v24, v25, v26);
  if ( v122 != v124 )
    free((__int64)v122, *(double *)&v19, v20, v21, v22, v23, v24, v25, v26);
