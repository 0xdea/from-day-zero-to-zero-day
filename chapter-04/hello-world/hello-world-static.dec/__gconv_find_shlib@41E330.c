_QWORD *__fastcall _gconv_find_shlib(__int64 a1)
{
  ...
  v41 = a1;
  v1 = (_QWORD *)tfind(&v41, &loaded, known_compare);
  if ( !v1 )
  {
    v14 = v41;
    v15 = strlen(v41);
    v16 = v15 + 1;
    v31 = (_QWORD *)malloc(v15 + 49, v23, v24, v25, v26, v27, v28, v29, v30, v17, v18, v19, v20, v21, v22);
    v32 = (__int64)v31;
    v2 = v31;
    if ( !v31 )
      return 0;
    *v31 = _memcpy_chk((__int64)(v31 + 6), v14, v16, v16);
    *(_DWORD *)(v32 + 8) = -3;
    *(_QWORD *)(v32 + 16) = 0;
    if ( !tsearch(v32, &loaded, known_compare) )
    {
      v2 = 0;
      free(v32, v33, v34, v35, v36, v37, v38, v39, v40);
      return v2;
    }
LABEL_3:
    v3 = *((_DWORD *)v2 + 2);
