__int64 *__fastcall _printf_fphex_buffer(unsigned __int64 a1, _BYTE *a2, __int64 a3, __int128 **a4)
{
  ...
  long double v88; // [xsp+10h] [xbp-50h]
  __int64 v89; // [xsp+10h] [xbp-50h]
  _BYTE v91[7]; // [xsp+35h] [xbp-2Bh] BYREF
  _BYTE v92[12]; // [xsp+3Ch] [xbp-24h] BYREF
  _BYTE v93[3]; // [xsp+48h] [xbp-18h] BYREF
  _BYTE v94[13]; // [xsp+4Bh] [xbp-15h] BYREF
  __int64 v95; // [xsp+58h] [xbp-8h] BYREF
  __int64 v96; // [xsp+C0h] [xbp+60h]
  ...
  if ( (v6 & 1) == 0 )
  {
    ...
    v24 = itoa_word(*(_QWORD *)&v13 & 0xFFFFFFFFFFFFFLL, (__int64)&v95, 0x10u, v11 == 65);
    v25 = v24;
    if ( v24 > (unsigned __int64)v94 )
      v25 = memset(v94, 48, v24 - (_QWORD)v94);
...
LABEL_75:
  ...
  v77 = *v8;
  v14 = *((_QWORD *)v8 + 1) >> 63;
  *(_QWORD *)&v88 = *(_QWORD *)v8;
  *((_QWORD *)&v88 + 1) = *((_QWORD *)v8 + 1) & 0x7FFFFFFFFFFFFFFFLL;
  if ( v88 <= *(long double *)&xmmword_45A930 )
  {
    v22 = &v95;
    v89 = *((_QWORD *)&v77 + 1) & 0xFFFFFFFFFFFFLL | v77;
    v23 = v89 == 0;
    v29 = itoa_word(v77, (__int64)&v95, 0x10u, v11 == 65);
    v30 = v29;
    if ( v29 > (unsigned __int64)v93 )
      v30 = memset(v93, 48, v29 - (_QWORD)v93);
    v31 = itoa_word(*((_QWORD *)&v77 + 1) & 0xFFFFFFFFFFFFLL, v30, 0x10u, *(_DWORD *)(a3 + 8) == 65);
    v25 = v31;
    if ( v31 > (unsigned __int64)v92 )
      v25 = memset(v92, 48, v31 - (_QWORD)v92);
    v26 = HIWORD(*((_QWORD *)&v77 + 1)) & 0x7FFFLL;
    v27 = ((*((_QWORD *)&v77 + 1) & 0x7FFF000000000000LL) != 0) + 48;
    if ( (_DWORD)v26 )
    {
      if ( (HIWORD(v77) & 0x7FFFu) <= 0x3FFE )
      {
...
LABEL_47:
        ...
        {
          v38 = _ReadStatusReg(FPCR) & 0xC00000;
          if ( (_DWORD)v38 == 0x800000 )
          {
            if ( (_DWORD)v14 )
              goto LABEL_55;
            goto LABEL_160;
          }
          if ( (unsigned int)v38 > 0x800000 )
          {
            if ( (_DWORD)v38 == 12582912 )
              goto LABEL_127;
LABEL_170:
            v96 = v4;
            abort(v28, v38, v9, v36);
          }
          if ( !(_DWORD)v38 )
          {
            v39 = 1;
LABEL_54:
            if ( (((unsigned int)v36 | v39) & 1) != 0 )
              goto LABEL_55;
LABEL_127:
            v21 = (int)v28;
            goto LABEL_77;
        ...
        else
        {
          ...
          if ( (_DWORD)v40 != 0x400000 )
          {
            ...
            if ( (_DWORD)v14 )
            {
              if ( v37 > 7 || (_DWORD)v38 != 0 )
                goto LABEL_55;
LABEL_150:
              v84 = v25;
              v49 = itoa_word((int)v28, (__int64)v91, 0xAu, 0);
              v50 = v84;
              v51 = 4;
LABEL_79:
              v52 = *(_WORD *)(a3 + 12);
              v53 = v10 - (v9 + v51 + (unsigned int)&v91[-v49]);
              if ( v9 <= 0 )
              {
                v54 = v53 - 2;
                if ( (v52 & 8) != 0 )
...
LABEL_90:
                    ...
                    if ( v9 > 0 )
                    {
                      ...
                      _printf_buffer_write(a1, v79, v68);
                      if ( v71 > 0 )
                    ...
                    _printf_buffer_write(a1, v49, (unsigned __int64)&v91[-v49]);
...
LABEL_77:
        v78 = v25;
        v49 = itoa_word(v21, (__int64)v91, 0xAu, 0);
        v50 = v78;
        v51 = 4;
        if ( (_DWORD)v14 )
          goto LABEL_79;
