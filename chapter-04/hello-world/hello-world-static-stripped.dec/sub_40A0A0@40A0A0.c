        ...
        double a10)
{
  ...
  {
LABEL_97:
    v80 = sub_4098C0(v15, 0, a3, a4, a5, a6, a7, a8, a9, a10);
    v21 = v80;
    if ( v80 )
    {
      if ( !dword_49668C )
        return v21;
      v78 = a2;
      v79 = dword_49668C ^ 0xFFu;
      goto LABEL_100;
    }
    return 0;
  }
  if ( (unsigned __int8)byte_496688 >= v15 )
  {
...
LABEL_8:
      if ( (v19 & 0xF) != 0 )
        sub_407374((__int64)"malloc(): unaligned fastbin chunk detected 2", a3, a4, a5, a6, a7, a8, a9, a10);
...
LABEL_26:
            sub_407374((__int64)"malloc(): unaligned fastbin chunk detected", a3, a4, a5, a6, a7, a8, a9, a10);
      ...
      if ( v16 != (unsigned int)*(_QWORD *)(v19 + 8) >> 4 )
        sub_407374((__int64)"malloc(): memory corruption (fast)", a3, a4, a5, a6, a7, a8, a9, a10);
...
LABEL_90:
      ...
      while ( 1 )
      {
        ...
        if ( !v32 )
          goto LABEL_90;
        if ( (v32 & 0xF) != 0 )
          sub_407374((__int64)"malloc(): unaligned fastbin chunk detected 3", a3, a4, a5, a6, a7, a8, a9, a10);
        if ( byte_490F08 )
        {
          v27 = v32 + 16;
          v28 = (v32 + 16) >> 12;
...
LABEL_72:
    ...
    if ( v69 != v70 )
    {
      ...
      if ( *(_QWORD *)(v71 + 16) != v70 )
        sub_407374((__int64)"malloc(): smallbin double linked list corrupted", a3, a4, a5, a6, a7, a8, a9, a10);
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v47 <= 0x10 || (v49 = *((_QWORD *)a1 + 273), v49 < v47) )
        sub_407374((__int64)"malloc(): invalid size (unsorted)", a3, a4, a5, a6, a7, a8, a9, a10);
      v50 = v48[1];
      if ( v49 < v50 || v50 <= 0xF )
        sub_407374((__int64)"malloc(): invalid next size (unsorted)", a3, a4, a5, a6, a7, a8, a9, a10);
      if ( (*v48 & 0xFFFFFFFFFFFFFFF8LL) != v47 )
        sub_407374((__int64)"malloc(): mismatching next->prev_size (unsorted)", a3, a4, a5, a6, a7, a8, a9, a10);
      v52 = (int *)*((_QWORD *)v42 + 3);
      if ( *((int **)v52 + 2) != v42 || *((int **)v42 + 2) != v43 )
        sub_407374((__int64)"malloc(): unsorted double linked list corrupted", a3, a4, a5, a6, a7, a8, a9, a10);
      if ( (v50 & 1) != 0 )
        sub_407374((__int64)"malloc(): invalid next->prev_inuse (unsorted)", a3, a4, a5, a6, a7, a8, a9, a10);
...
LABEL_86:
    ...
    if ( v15 + 32 < v47 )
    {
      ...
      *((_QWORD *)a1 + 13) = (char *)v42 + v15;
      ...
      v128 = a2;
      v127 = (__int64)(v42 + 4);
      *((_QWORD *)v42 + 1) = v15 | (4LL * (a1 != &dword_490670)) | 1;
      v129[1] = v130 | 1;
      *v48 = v130;
      goto LABEL_217;
    }
...
LABEL_242:
        v144 = sub_41F250("chunk_main_arena (fwd)", "malloc.c", 4192, "_int_malloc");
        return sub_40AF50(v144);
      }
      if ( v62 <= v61 )
      {
        v107 = *((_QWORD *)v58 + 1);
        ...
        while ( v61 < v107 )
        {
          ...
          if ( (v107 & 4) != 0 )
          {
            v88 = sub_41F250("chunk_main_arena (fwd)", "malloc.c", 4196, "_int_malloc");
LABEL_222:
            ...
            sub_407C70((_QWORD *)i, a3, a4, a5, a6, a7, a8, a9, a10);
            if ( (unsigned __int64)&v10[-v15] > 0x1F )
            {
              ...
              *(_QWORD *)(i + 8) = v15 | (4LL * (a1 != &dword_490670)) | 1;
              v142[1] = v132 | 1;
              *(_QWORD *)&v10[i] = v132;
LABEL_233:
              v21 = i + 16;
...
LABEL_239:
        ...
        v60 = (int *)*((_QWORD *)v57 + 3);
        if ( *((int **)v60 + 2) != v57 )
          sub_407374((__int64)"malloc(): largebin double linked list corrupted (bk)", a3, a4, a5, a6, a7, a8, a9, a10);
      }
      else
      {
        v63 = *((_QWORD *)v58 + 5);
    ...
    while ( 1 )
    {
      ...
      if ( v102 > 3 )
      {
        ...
        if ( *((_QWORD *)a1 + 273) < v105 )
          sub_407374((__int64)"malloc(): corrupted top size", a3, a4, a5, a6, a7, a8, a9, a10);
        if ( v15 + 32 <= v105 )
        {
          v143 = v104 + v15;
          *((_QWORD *)a1 + 12) = v104 + v15;
          v21 = v104 + 16;
          *(_QWORD *)(v104 + 8) = v15 | (4LL * (a1 != &dword_490670)) | 1;
          v128 = a2;
        ...
        if ( !a1[2] )
        {
          v127 = sub_4098C0(v15, a1, a3, a4, a5, a6, a7, a8, a9, a10);
          v21 = v127;
          if ( !v127 )
            return v21;
          v128 = a2;
...
LABEL_118:
    if ( (v93 & v94) != 0 )
    {
      ...
      v111 = i - v15;
      sub_407C70(*((_QWORD **)v92 + 3), a3, a4, a5, a6, a7, a8, a9, a10);
      if ( i - v15 <= 0x1F )
      {
        *(_QWORD *)(v95 + i + 8) |= 1uLL;
        if ( a1 != &dword_490670 )
      ...
      else
      {
        ...
        v121 = (_QWORD *)(v95 + v15);
        if ( *(int **)(v120 + 24) != v43 )
          sub_407374((__int64)"malloc(): corrupted unsorted chunks 2", v112, v113, v114, v115, v116, v117, v118, v119);
        v121[2] = v120;
        v121[3] = v43;
        *((_QWORD *)a1 + 14) = v121;
        *(_QWORD *)(v120 + 24) = v121;
        ...
        *(_QWORD *)(v95 + 8) = v15 | (4LL * (a1 != &dword_490670)) | 1;
        v121[1] = v111 | 1;
        *(_QWORD *)(v95 + i) = v111;
      }
      v21 = v95 + 16;
...
LABEL_100:
  ...
  if ( v93 )
    goto LABEL_118;
  sub_41F250("bit != 0", "malloc.c", 4357, "_int_malloc");
LABEL_208:
  v96 = 8 * v41;
LABEL_209:
  v122 = *(_QWORD *)(StatusReg + 56);
  ...
  if ( (v21 & 0xF) != 0 )
LABEL_236:
    sub_407374((__int64)"malloc(): unaligned tcache chunk detected", a3, a4, a5, a6, a7, a8, a9, a10);
  v124 = 2 * v41;
