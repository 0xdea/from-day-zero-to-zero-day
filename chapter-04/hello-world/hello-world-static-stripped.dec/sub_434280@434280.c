        ...
        __int64 a17)
{
  ...
  __int64 v162; // x2
  __int64 v163; // x0
  __int64 v164; // [xsp+0h] [xbp-10030h] BYREF
  void *v165; // [xsp+30h] [xbp-10000h] BYREF
  unsigned __int64 v166; // [xsp+38h] [xbp-FFF8h]
  __int64 v167; // [xsp+48h] [xbp-FFE8h]
  unsigned __int64 v168; // [xsp+50h] [xbp-FFE0h] BYREF
  __off_t v169; // [xsp+58h] [xbp-FFD8h]
  int v170[232]; // [xsp+60h] [xbp-FFD0h]
  __int64 v171; // [xsp+400h] [xbp-FC30h]
  _QWORD v172[6]; // [xsp+10000h] [xbp-30h] BYREF
  __int64 v173; // [xsp+10030h] [xbp+0h] BYREF
  char *v174; // [xsp+10090h] [xbp+60h]
  __int64 v175; // [xsp+10098h] [xbp+68h]
  unsigned __int64 v176; // [xsp+100A0h] [xbp+70h]
  unsigned __int64 v177; // [xsp+100A8h] [xbp+78h]
  void **v178; // [xsp+100B0h] [xbp+80h]
  __int64 v179; // [xsp+100B8h] [xbp+88h]
  void **v180; // [xsp+100C0h] [xbp+90h]
  size_t *v181; // [xsp+100C8h] [xbp+98h]
  int *v182; // [xsp+100D0h] [xbp+A0h]
  __int64 v183; // [xsp+100D8h] [xbp+A8h]
  _QWORD *v184; // [xsp+100E0h] [xbp+B0h]
  int v185; // [xsp+100ECh] [xbp+BCh]
  __int64 *v186; // [xsp+100F0h] [xbp+C0h]
  int v187; // [xsp+100F8h] [xbp+C8h]
  int v188; // [xsp+100FCh] [xbp+CCh]
  __int64 v189; // [xsp+10100h] [xbp+D0h]
  __int64 v190; // [xsp+10108h] [xbp+D8h]
  __int64 v191; // [xsp+10110h] [xbp+E0h] BYREF
  __int64 v192; // [xsp+10118h] [xbp+E8h]
...
LABEL_4:
    ...
    if ( (a7 & 4) != 0 )
    {
      sub_40C1A0(a4, a9, a10, a11, a12, a13, a14, a15, a16);
      v25 = 0;
      sub_410CD0(a2);
      return v25;
    }
    ...
    v25 = (__int64 *)sub_437850(a4, a1, a6, a5, (unsigned int)a7, a17);
    if ( !v25 )
    {
      v188 = *(_DWORD *)(_ReadStatusReg(TPIDR_EL0) + 40);
      if ( a2 != -1 )
        sub_410CD0(a2);
    ...
    v29 = *(_QWORD *)(a3 + 40);
    v31 = 56LL * v27;
    v187 = *(unsigned __int16 *)(v26 + 16);
    v25[95] = v30;
    *((_WORD *)v25 + 384) = v27;
    if ( v31 + v29 > v28 )
    {
      while ( v172 != (_QWORD *)((char *)v172 - (((_DWORD)v31 + 15) & 0x7F0000)) )
        v171 = 0;
      v172[0] = 0;
      ...
      v184 = (_QWORD *)v26;
      v186 = &v173;
      v99 = sub_430F90(a2, &v173, v31, v29);
      v26 = (__int64)v184;
      if ( v99 != v31 )
      {
        v188 = *(_DWORD *)(_ReadStatusReg(TPIDR_EL0) + 40);
    ...
    {
      v186 = (__int64 *)(v26 + v29);
    }
    v32 = *((unsigned __int16 *)v25 + 384);
    v184 = v172;
    v33 = 7LL * v32;
    v34 = (_QWORD *)((char *)v172 - (((_DWORD)(v33 * 8) + 15) & 0x7F0000));
    if ( v172 != v34 )
    {
      do
        v171 = 0;
    ...
    {
      v171 = 0;
      v35 = (unsigned __int64)&v186[v33];
      if ( (unsigned __int64)v186 >= v35 )
        goto LABEL_214;
    }
    else
    {
          ...
          if ( v44 )
          {
            ...
            if ( v187 == 3 )
            {
              if ( v25[2] && !v38 )
              {
                v56 = i - 1;
                v57 = v165;
                v58 = *(&v167 + 7 * v56) - (_QWORD)v165;
                if ( v37 >= v168 )
                {
                  v59 = *(&v167 + 7 * v56) - (_QWORD)v165;
                  v178 = (void **)v26;
                  LODWORD(v179) = v39;
                  LODWORD(v180) = v40;
                  v60 = sub_4117E0(v165, v59, v170[0], 2050, a2, v169);
                  v25[115] = v60;
                  v61 = v60;
                  if ( v60 != -1 )
                  {
...
LABEL_94:
                  v100 = (void *)v25[115];
                  if ( v100 )
                    sub_4118C0(v100, v25[116] - (_QWORD)v100);
                  v101 = v25[114];
                  if ( v101 != -1 )
                    sub_40C1A0(v101, a9, a10, a11, a12, a13, a14, a15, a16);
                  v102 = v25[7];
                  if ( !*(_DWORD *)(v102 + 16) )
                    sub_40C1A0(v102, a9, a10, a11, a12, a13, a14, a15, a16);
                  if ( (*((_WORD *)v25 + 434) & 0x1000) != 0 )
                    sub_40C1A0(v25[94], a9, a10, a11, a12, a13, a14, a15, a16);
LABEL_102:
                  sub_40C1A0((unsigned __int64)v25, a9, a10, a11, a12, a13, a14, a15, a16);
                  sub_40C1A0(a4, v103, v104, v105, v106, v107, v108, v109, v110);
                  sub_432250(v188, a1, 0, v80);
                }
                v150 = v168 + v58;
                if ( v168 > v58 )
                  v150 = 2 * v168;
                ...
                v179 = v168;
                v180 = (void **)v150;
                v151 = sub_4117E0(v165, v150, 0, 2082, -1, 0);
                v152 = v151;
                if ( v151 == -1 )
                  goto LABEL_57;
                v153 = (void *)((v179 - 1 + v151) & -v179);
                v179 = v152;
                v154 = (char *)sub_4117E0(v153, v58, v170[0], 2066, a2, v169);
                v61 = (size_t)v154;
                v26 = v176;
                ...
                if ( v154 == (char *)-1LL )
                {
                  sub_4118C0((void *)v179, (size_t)v180);
                  goto LABEL_57;
                }
                if ( v154 != (char *)v179 )
                {
                  ...
                  v175 = v176;
                  LODWORD(v176) = v177;
                  LODWORD(v177) = (_DWORD)v178;
                  v178 = (void **)v154;
                  sub_4118C0((void *)v179, (size_t)&v154[-v179]);
                  v39 = v176;
                ...
                v35 = (unsigned __int64)v180 + v155;
                v156 = (_BYTE *)((*v181 - 1 + v62) & -(__int64)*v181);
                v157 = (char *)v180 + v155 - v156;
                if ( (char *)v180 + v155 == v156 )
                {
                  v25[115] = v61;
                }
                else
                {
                  ...
                  LODWORD(v179) = v63;
                  v180 = (void **)v61;
                  sub_4118C0(v156, v157);
                  v61 = (size_t)v180;
                  v25[115] = (__int64)v180;
                  v62 = v176;
                  v26 = v177;
                  v39 = (int)v178;
                  LOBYTE(v63) = v179;
...
LABEL_41:
                ...
                *v25 = v64;
                ...
                if ( (v63 & 1) != 0 )
                {
                  v179 = v26;
                  LODWORD(v180) = v39;
                  v65 = (unsigned __int64)*(&v165 + 7 * v44 - 7);
                  if ( v65 < v166 )
                  {
                    v80 = "ELF load command address/offset not page-aligned";
                    goto LABEL_206;
                  }
                  v66 = sub_411880((void *)(v64 + v166), v65 - v166, 0);
                  v26 = v179;
                  v39 = (int)v180;
                  if ( v66 < 0 )
                  {
                  ...
                  if ( (unsigned __int64)v68 > v69 )
                  {
                    ...
                    if ( v35 < (unsigned __int64)v71 )
                    {
                      ...
                      else
                      {
                        ...
                        v179 = v35;
                        LODWORD(v180) = v72;
                        if ( (sub_411880((void *)(v35 & -(__int64)v70), v70, v72 | 2u) & 0x80000000) != 0 )
                          goto LABEL_210;
                        v163 = ifunc_40DE70(v179, 0, &v71[-v179]);
                        sub_411880((void *)(-(__int64)*v181 & v163), *v181, (int)v180);
                        v26 = v175;
                        v62 = v177;
                        v67 = v178;
                        v39 = v176;
                    ...
                    if ( v62 > (unsigned __int64)v71 )
                    {
                      ...
                      LODWORD(v179) = v39;
                      v180 = v67;
                      v145 = sub_4117E0(v71, v62 - (_QWORD)v71, v144, 50, -1, 0);
                      v26 = (__int64)v178;
                      v67 = v180;
                      v39 = v179;
                      if ( v145 == -1 )
...
LABEL_139:
                  ...
                  if ( v127 )
                  {
                    ...
                    *((_DWORD *)v25 + 265) = v128;
                    ...
                    if ( (v128 & 8) != 0 )
                      *((_BYTE *)v25 + 872) = 1;
                    if ( (*v182 & 0x40) != 0 && (v128 & 0xF7FFF716) != 0 )
                    {
                      v181 = (size_t *)v26;
                      LODWORD(v184) = v39;
                ...
                else
                {
                  ...
                  if ( !v132 )
                  {
                    ...
                    else
                    {
                      ...
                      v25[94] = j_ifunc_40DC90(v160, v186, v159);
...
LABEL_174:
                    ...
                    if ( (a7 & 8) == 0 )
                    {
                      if ( v25[24] )
                      {
                        v161 = (__int64 **)v25[122];
                        if ( *v161 != v25 + 97 )
                        {
                          v162 = v25[121];
                          *(_QWORD *)v25[99] = v25;
                          *((_DWORD *)v25 + 200) = 1;
                          j_ifunc_40DD80(v161 + 1, v161, 8 * (v162 - 1));
                          *(_QWORD *)v25[122] = v25 + 99;
                        }
                      }
                    }
                    if ( (*((_DWORD *)v25 + 265) & 0x20) != 0 )
                      qword_496808 = (__int64)v25;
                    v141 = v190;
                    v25[125] = v189;
                    v25[126] = v141;
                    if ( !(&off_4914A8)[21 * a17 + 4] )
                    {
                      v146 = v25[22];
                      if ( v146 )
                      {
                        ...
                        if ( !(unsigned int)sub_42F240(
                          ...
                          (&off_4914A8)[21 * a17 + 4] = v25;
                      }
                    }
                    if ( v25[143] && ((*((_WORD *)v25 + 434) & 3) == 1 || qword_4921A8) )
                      sub_412800((__int64)v25);
                    sub_4377B0(v25, a17);
                    if ( (a7 & 0x40000000) == 0 )
                    {
                      v142 = sub_412370(a17);
...
LABEL_26:
      ...
      case 1u:
        ...
        *v50 = (void *)(v45 & v42);
        ...
        if ( ((v49 - 1) & v49) == 0 && (unsigned __int64)v43 < v49 )
          v43 = (void *)v49;
        *(_QWORD *)&v170[14 * v44 - 2] = v46 & v42;
        if ( v24 > 1 && (void *)(v45 & v42) != *(v50 - 6) )
          v40 = 1;
        v52 = 7 * v44++;
        v170[2 * v52] = (1934713408 >> (4 * (*((_BYTE *)v36 + 4) & 7))) & 0xF;
        break;
    }
    goto LABEL_26;
  }
  if ( (sub_410930(a2, (struct stat *)&v191) & 0x80000000) != 0 )
  {
    v188 = *(_DWORD *)(_ReadStatusReg(TPIDR_EL0) + 40);
    if ( a2 != -1 )
      sub_410CD0(a2);
  ...
  v189 = v191;
  v190 = v192;
  v25 = (&off_4914A8)[21 * a17];
  if ( !v25 )
    goto LABEL_4;
  while ( (*((_BYTE *)v25 + 870) & 4) != 0 || v25[125] != v191 || v25[126] != v192 )
  {
    v25 = (__int64 *)v25[3];
    if ( !v25 )
      goto LABEL_4;
  ...
  sub_410CD0(a2);
  sub_40C1A0(a4, v88, v89, v90, v91, v92, v93, v94, v95);
  sub_433530((unsigned __int64 *)v25[7], (unsigned __int64 *)a1);
  return v25;
}
