__int64 __fastcall sub_433BD0(__int64 a1, _BYTE *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v55 = *(unsigned __int8 *)qword_496840;
    do
    {
      v56 = *(_QWORD *)(a3 + 8);
      v57 = v55;
...
LABEL_34:
  ...
  v29 = sub_40B890(v28, v16, v17, v18, v19, v20, v21, v22, v23, v25, v11, v12, v13, v14, v15);
  v38 = (_QWORD *)v29;
  if ( !v29 )
  {
    sub_40C1A0(v24, v30, v31, v32, v33, v34, v35, v36, v37);
    v62 = "cannot create cache for search path";
    goto LABEL_34;
  }
  sub_433970(v24, v29, (__int64)":", a4, (__int64)v8, a3);
  sub_40C1A0(v24, v39, v40, v41, v42, v43, v44, v45, v46);
  if ( !*v38 )
  {
    sub_40C1A0((unsigned __int64)v38, v47, v48, v49, v50, v51, v52, v53, v54);
    goto LABEL_3;
  }
  *(_QWORD *)a1 = v38;
  *(_DWORD *)(a1 + 8) = 1;
