__int64 __fastcall sub_4302C0(__int64 a1)
{
  atomic_uint *v1; // x21
  ...
  if ( _aarch64_cas4_acq(0, 1u, (atomic_uint *)(a1 + 4)) )
    sub_406F40(v1, v11, v12, v13, v14, v15, v16, v17, v18, v5, v6, v7, v8, v9, v10);
  v19 = *(_QWORD *)(a1 + 24);
  if ( v19 >= *(_QWORD *)(a1 + 16) )
  {
    v20 = a1 + 48;
    v29 = sub_430270(*(_DWORD *)a1, (void *)(a1 + 48), *(_QWORD *)(a1 + 8), v7, v8, v9, v10);
    if ( v29 <= 0 )
    {
  ...
  *(_QWORD *)(a1 + 32) = v21;
  if ( (int)_aarch64_swp4_rel(0, v1) > 1 )
LABEL_6:
    sub_407040(v1, v22, v23, v24, v25, v26, v27);
  return v20;
}
