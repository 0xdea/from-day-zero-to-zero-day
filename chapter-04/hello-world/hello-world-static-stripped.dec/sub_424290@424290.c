int8x16_t *__fastcall sub_424290(unsigned __int64 a1, int8x16_t *a2, int8x16_t *a3, unsigned __int8 *a4)
{
  ...
  if ( (unsigned __int64)a2->n128_u64 - a1 >= v7 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a1 > (unsigned __int64)v27->n128_u64 + v30 )
        return v27;
      while ( (unsigned int)sub_40DAC0(v10, a3, v8) )
      {
...
LABEL_22:
      if ( a1 > (unsigned __int64)v21 )
        return v27;
      for ( i = v21; (unsigned int)sub_40DAC0(i, a3, v8); i = (int8x16_t *)((char *)i - 1) )
      {
