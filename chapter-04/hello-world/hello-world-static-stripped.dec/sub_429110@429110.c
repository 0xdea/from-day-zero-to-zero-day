unsigned __int64 __fastcall sub_429110(
        __int64 a1,
        unsigned __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        double a12)
{
  ...
  if ( (*(_DWORD *)a4 & 0x8000) == 0 )
  {
    ...
    else
    {
      if ( _aarch64_cas4_acq(0, 1u, *(atomic_uint **)(a4 + 136)) )
        sub_406F40((_DWORD *)v18, a5, a6, a7, a8, a9, a10, a11, a12, v21, v22, v23, v24, v25, v26);
  ...
  v28 = *(_QWORD *)(a4 + 216);
  if ( (unsigned __int64)(v28 - (_QWORD)&unk_48DD70) > 0x92F )
    ...
    else if ( !v34 )
    {
      *((_QWORD *)v33 + 1) = 0;
      if ( (int)_aarch64_swp4_rel(0, (atomic_uint *)v33) > 1 )
        sub_407040(v33, v35, v36, v37, v38, v39, v40);
      goto LABEL_14;
    }
    v33[1] = v34 - 1;
    v41 = v30 || v12 == v29;
