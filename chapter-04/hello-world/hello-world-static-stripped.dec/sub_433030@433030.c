        ...
        _BYTE *a8)
{
  ...
  _QWORD *v76; // [xsp+20090h] [xbp+80h]
  _QWORD *v77; // [xsp+20098h] [xbp+88h]
  ...
  if ( *a4 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v21 )
      {
        v50 = (const char *)v20[1];
        if ( v50 != v80 )
        {
          v81 = v69;
          v51 = (_QWORD *)v20[2];
          v52 = (_QWORD *)((char *)v69 - ((qword_496A00 + 15) & 0xFFFFFFFFFFFF0000LL));
          if ( v69 != v52 )
          {
            do
              v68 = 0;
          ...
          if ( *v87 )
          {
            ...
            do
            {
              if ( v56 != (const char *)v59[1] )
                break;
              v61 = j_ifunc_40DC90(v58, v59[3], v59[4]);
      ...
      v31 = j_ifunc_40DC90(v22, a1, a2) + a2 - (_QWORD)v18;
      if ( (*v17 & 1) != 0 )
        sub_438334("  trying file=%s\n", v18);
      v32 = sub_432B50(v18, a6, a8, 0);
      v37 = v32;
      v38 = *((unsigned int *)v20 + 10);
      if ( (_DWORD)v38 )
      {
        v39 = (_DWORD)v38 != 1;
        if ( v32 == -1 )
...
LABEL_25:
          ...
          v18[v31 - a2] = 0;
          if ( (unsigned int)sub_443FD0(v18, v89) )
          {
            LODWORD(v39) = 0;
            *((_DWORD *)v20 + 10) = 1;
          }
      ...
      if ( ((unsigned int)v88 & 0x4000000) != 0
        && *v82
        && ((LODWORD(v81) = v39, v49 = sub_410930(v32, (struct stat *)v89), v39 = (unsigned int)v81, v49)
         || (v90 & 0x800) == 0) )
      {
        sub_410CD0(v37);
      ...
      {
        v40 = a5;
        v41 = sub_40B890(v31, v23, v24, v25, v26, v27, v28, v29, v30, v38, v33, v39, v34, v35, v36);
        v42 = v37;
        *v40 = v41;
        if ( v41 )
        {
          j_ifunc_40DC90(v41, v18, v31);
        }
        else
        {
          v42 = -1;
      ...
      if ( !v44 )
      {
        ...
        if ( v45 != 1 )
        {
          if ( *((_DWORD *)v78 + 2) )
          {
            v65 = *v78;
            v88 = v78;
            sub_40C1A0(v65, v23, v24, v25, v26, v27, v28, v29, v30);
            v46 = v88;
          }
          v64 = v46 == &qword_48FAF8 || v46 == &qword_48FB08;
          if ( !v64 )
          {
            v42 = -1;
            *v46 = -1;
