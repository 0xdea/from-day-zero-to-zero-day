char *__fastcall sub_44EA10(char *result, unsigned __int64 a2, __int64 a3, unsigned __int64 a4)
{
  __int64 v4; // x29
  __int64 v5; // x30
        ...
        default:
          switch ( *result )
          {
            ...
            case 1:
              ...
              result = sub_44DBE0(v8, *(_BYTE *)(v6 + 960), result + 1, (unsigned __int64 *)&v114);
              v9 = v114;
              *(_QWORD *)(v6 + 920) = v114;
              continue;
            case 2:
...
LABEL_73:
            ...
            default:
              ...
              sub_4002C0((__int64)result, v9, a3, a4);
          }
      }
LABEL_11:
