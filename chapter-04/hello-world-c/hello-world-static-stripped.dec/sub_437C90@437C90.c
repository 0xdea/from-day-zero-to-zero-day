ssize_t __fastcall sub_437C90(int a1, int a2, unsigned __int8 *a3, __int64 a4)
{
  ...
  do
  {
    if ( a2 == 1 )
    {
      if ( !v8 )
      {
        ...
        v8 = v47;
        if ( v47 < 0 )
          sub_41F250("pid >= 0 && sizeof (pid_t) <= 4", (__int64)"dl-printf.c", 0x48u, (__int64)"_dl_debug_vdprintf");
        v48 = sub_4244D0(v47, (__int64)&v69, 0xAu, 0);
        if ( v48 > (unsigned __int64)v68 )
          ifunc_40DE70(v68, 32, v48 - (_QWORD)v68);
        v69 = 2362;
      }
      if ( v9 > 63 )
        sub_41F250("niov < NIOVMAX", (__int64)"dl-printf.c", 0x51u, (__int64)"_dl_debug_vdprintf");
      v10 = v9++;
      a2 = -1;
      v70[v10].iov_len = 12;
...
LABEL_21:
      if ( v9 > 63 )
LABEL_129:
        sub_41F250("niov < NIOVMAX", (__int64)"dl-printf.c", 0x5Eu, (__int64)"_dl_debug_vdprintf");
      v17 = v9;
...
LABEL_33:
      ...
      if ( v20 == 42 )
      {
        ...
        v23 = *v28;
        if ( *v28 > 19 )
          sub_41F250("width < IFMTSIZE", (__int64)"dl-printf.c", 0x79u, (__int64)"_dl_debug_vdprintf");
      ...
      if ( v20 == 108 || v20 == 122 )
      {
        ...
        if ( v20 != 115 )
        {
          if ( v20 > 0x73 )
          {
            if ( v20 != 117 && v20 != 120 )
LABEL_51:
              sub_41F250("! \"invalid format specifier\"", (__int64)"dl-printf.c", 0xDDu, (__int64)"_dl_debug_vdprintf");
          }
          else
          {
            ++v21;
...
LABEL_113:
                  ...
                  v63 = v23;
                  v66 = v38;
                  v41 = (char *)sub_4244D0(v56, (__int64)v39, 0xAu, 0);
                  v53 = v41;
                  v43 = v59;
                  v44 = v66;
                  if ( v63 != -1 )
...
LABEL_77:
                ...
                v62 = v23;
                v65 = v38;
                v41 = (char *)sub_4244D0(v37, (__int64)v39, v40, 0);
                v42 = v60;
                v43 = v58;
                v44 = v65;
                if ( v62 == -1 )
