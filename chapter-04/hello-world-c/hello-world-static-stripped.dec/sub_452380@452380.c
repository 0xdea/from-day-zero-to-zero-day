__int64 __fastcall sub_452380(__int64 a1, char *a2, unsigned __int64 *a3)
{
  unsigned int v3; // w19
  __int64 v6; // x24
  int v7; // w20
...
LABEL_23:
    ...
    {
LABEL_29:
      v16 = sub_450F40(v12, v6, v9 + 8, &v24);
      if ( v12 == 255 )
        goto LABEL_22;
LABEL_30:
      v18 = v12 & 7;
    ...
    v14 = sub_4519C4((unsigned __int8 *)&v9[-v11 + 4]);
    v7 = v14;
    if ( v14 == 255 )
      return -1;
...
LABEL_14:
          ...
          {
LABEL_47:
            sub_4002C0(v18, v15, (__int64)v16, v17);
          }
          v15 = -1;
LABEL_17:
          if ( (v24 & v15) != 0 )
