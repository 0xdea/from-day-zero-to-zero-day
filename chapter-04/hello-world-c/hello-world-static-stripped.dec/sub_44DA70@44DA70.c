__int64 __fastcall sub_44DA70(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // x0
  __int64 v7; // x23
  __int64 i; // x19
  ...
  for ( i = 0; i != 97; ++i )
  {
    while ( 1 )
    {
      ...
      if ( *(_BYTE *)(a2 + 856 + i) )
      {
        if ( v5 )
        {
          v9 = (unsigned __int8)byte_496C40[i];
          if ( (_DWORD)v9 != 8 )
            goto LABEL_34;
          *(_QWORD *)v5 = v10;
        }
...
LABEL_8:
    ...
    v13 = (unsigned __int8)byte_496C40[i];
    j_ifunc_40DC90(v5, v10, v13);
  }
LABEL_19:
