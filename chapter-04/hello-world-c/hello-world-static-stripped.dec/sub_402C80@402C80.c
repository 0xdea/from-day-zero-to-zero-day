        ...
        double a9)
{
  ...
  if ( (unsigned __int64)v9 < *(_QWORD *)(a1 + 16) )
    return *v9;
  if ( (unsigned int)sub_401BC0(a1, a2, a3, a4, a5, a6, a7, a8, a9) )
  {
    v21 = *(_QWORD *)(a1 + 216);
    if ( (unsigned __int64)(v21 - (_QWORD)&unk_48DD70) > 0x92F )
      sub_401A50(v12, v13, v14, v15, v16, v17, v18, v19);
