__int64 sub_411E50()
{
  ...
  v53 = qword_48DD60;
  v5 = sub_410EE0("/sys/kernel/mm/transparent_hugepage/enabled", 0);
  if ( v5 == -1 )
    goto LABEL_8;
  v55 = v0;
  v56 = v1;
  v6 = v5;
  v7 = sub_410FC0(v5, v52, 0x18u);
...
LABEL_9:
  ...
  *v15 = 0;
  if ( v11 )
  {
    v18 = sub_410EE0("/sys/kernel/mm/hugepages", 0x4000);
    if ( v18 != -1 )
    {
      v50 = v1;
      v49 = v0;
...
LABEL_16:
      ...
      if ( (unsigned __int64)(v19 + 1) > 1 )
      {
        ...
        *v13 = v14;
        *v16 = ((unsigned int)__clz(__rbit64(v14)) << 26) | 0x40000;
      }
      sub_410CD0(v18);
      v0 = v49;
      v1 = v50;
