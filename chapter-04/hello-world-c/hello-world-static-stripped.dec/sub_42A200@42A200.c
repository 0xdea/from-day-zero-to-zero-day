        ...
        double a9)
{
  ...
  {
    if ( *(_QWORD *)(a1 + 72) )
      sub_42A030((unsigned int *)a1, a2, a3, a4, a5, a6, a7, a8, a9);
    goto LABEL_8;
  }
  if ( (unsigned int)sub_4296F0(a1, v11[1], a2, a3, a4, a5, a6, a7, a8, a9) )
    return 0xFFFFFFFFLL;
LABEL_8:
  v13 = *(_QWORD *)(a1 + 216);
  if ( (unsigned __int64)(v13 - (_QWORD)&unk_48DD70) > 0x92F )
