      ...
      if ( a6 )
      {
        ...
        if ( v15 > v14
          ...
          && (v101 = *(unsigned __int64 *)((char *)v12 + v10),
              v17 = sub_448C20((__int64)v12, (__int64)a5, a6 - 1),
              v14 = v101,
              v17 < 0) )
        {
          v104 = 0;
        ...
        if ( v18 >= 0 )
        {
          ...
          do
          {
            if ( a2 > v18 )
            {
              ...
              {
                v110 = v14;
                j_ifunc_40DD80(v12 + 1, v12, v106 * 8);
                v14 = v110;
              }
              *v12 = 0;
            }
            ...
            if ( v102 != sub_44A2F0(v12, a5, a6, v19) )
            {
              --v19;
              sub_44D1A0(v12, v12, a5, a6);
            }
            *(_QWORD *)(a1 + 8 * v18--) = v19;
            v14 = *v13;
          }
