...
char **__fastcall sub_43B3B0(const char *a1, unsigned __int64 a2, unsigned int a3, __int64 *a4)
{
  char *v8; // x19
  ...
  _BYTE v94[992]; // [xsp+20020h] [xbp-10040h] BYREF
  __int64 v95; // [xsp+20400h] [xbp-FC60h]
  _BYTE v96[40]; // [xsp+30000h] [xbp-60h] BYREF
  unsigned __int64 *v97; // [xsp+30028h] [xbp-38h] BYREF
  ...
  unsigned __int64 v102; // [xsp+30050h] [xbp-10h] BYREF
  __int64 v103; // [xsp+30058h] [xbp-8h]
  ...
  if ( !*v8 )
  {
    v14 = sub_422890("LC_ALL");
    v97 = (unsigned __int64 *)v14;
    if ( v14 && *v14
      || (v16 = sub_422890(&aLcCollate[(unsigned __int8)asc_45B298[a3]]), (v97 = (unsigned __int64 *)v16) != 0) && *v16 )
    {
      v15 = v97;
    }
    else
    {
      v15 = (unsigned __int64 *)sub_422890("LANG");
      v97 = v15;
      if ( !v15 )
      {
LABEL_29:
        v8 = "C";
        v97 = (unsigned __int64 *)"C";
        goto LABEL_2;
      }
    }
    if ( *(_BYTE *)v15 )
    {
      v8 = (char *)v97;
      if ( !(unsigned int)sub_42F240(v97, (unsigned __int64)"C") )
        goto LABEL_25;
      goto LABEL_3;
    }
    goto LABEL_29;
...
LABEL_2:
  if ( !(unsigned int)sub_42F240((unsigned __int64 *)v8, (unsigned __int64)"C") )
  {
LABEL_25:
    *a4 = (__int64)"C";
    result = off_48FB20[a3];
    goto LABEL_13;
  }
LABEL_3:
  if ( !(unsigned int)sub_42F240((unsigned __int64 *)v8, (unsigned __int64)"POSIX") )
    goto LABEL_25;
  v9 = ifunc_40DFD0(v8);
  v10 = v9;
...
LABEL_11:
  ...
  *a4 = (__int64)v97;
  if ( a1 )
  {
    v17 = (unsigned __int64 *)sub_4210F0((__int64)v12);
    v97 = v17;
    goto LABEL_31;
  }
  result = (char **)sub_43BC10(a3, a4);
  if ( result )
    goto LABEL_13;
  v97 = (unsigned __int64 *)sub_4210F0(*a4);
  if ( v97 )
  {
    result = (char **)sub_43BC10(a3, &v97);
    if ( result )
      goto LABEL_13;
    v17 = v97;
    a2 = 16;
...
LABEL_32:
  ...
  if ( v20 >= 0x400uLL )
    v95 = 0;
  v22 = (unsigned __int8 *)sub_412300((__int64)v94, (__int64)v17, v19, v19);
  v31 = sub_421970(v22, &v98, &v99, &v100, &v101, &v102, v23, v24, v25, v26, v27, v28, v29, v30);
  v32 = v31;
  if ( v31 == -1 )
    goto LABEL_19;
  v33 = &aLcCollate[(unsigned __int8)asc_45B298[a3]];
  v39 = sub_421300(
          &qword_496A20[a3],
          (__int64)a1,
          a2,
  ...
  if ( (v32 & 1) != 0 )
    sub_40C1A0(v102, v40, v41, v42, v43, v44, v45, v46, v47);
  if ( !*((_DWORD *)v39 + 2) )
    sub_43C8A4(v39, a3);
  v48 = (_QWORD *)v39[2];
  if ( !v48 )
  ...
  if ( v101 )
  {
    v50 = &v48[dword_45C3E0[a3]];
    v51 = (_BYTE *)v50[7];
    if ( !v51 )
      goto LABEL_121;
    v52 = ifunc_40DFD0(v50[7]) + 18;
    v53 = v52 & 0xFFFFFFFFFFFF0000LL;
    v54 = v52 & 0xFFF0;
    v55 = (__int64 *)(v94 - v53 + 16);
    if ( &v93 != v55 )
    {
      do
        v92 = 0;
...
LABEL_52:
    ...
    v70 = 1;
LABEL_83:
    v57 = (_BYTE *)(ifunc_40DE70(v57, 47, (unsigned int)(3 - v70)) + (unsigned int)(3 - v70));
LABEL_84:
    *v57 = 0;
    v71 = ifunc_40DFD0(v49) + 18;
...
LABEL_91:
    ...
    v61 = 1;
LABEL_69:
    v62 = (_BYTE *)(ifunc_40DE70(v62, 47, (unsigned int)(3 - v61)) + (unsigned int)(3 - v61));
LABEL_70:
    v63 = v88;
    *v62 = 0;
    do
    ...
    while ( v68 );
    if ( (unsigned int)sub_415EA0((__int64)v88, (__int64)v91) )
      goto LABEL_19;
    v48 = (_QWORD *)v39[2];
  }
  if ( !*v48 )
  {
    v83 = sub_42F700(*v39, 0x2Fu, v34, v35, v36, v37, v38);
    v84 = v83 - 1;
    if ( *(_BYTE *)(v83 - 2) == 47 )
    {
      v86 = 1;
    ...
    *v48 = ((__int64 (__fastcall *)(unsigned __int64, __int64))loc_443350)(v84, v86);
  }
  if ( !v99 || (unsigned int)sub_42F110(v99, (__int64)"TRANSLIT", (__int64)off_48FA10) )
  {
    result = (char **)v39[2];
  }
  else
