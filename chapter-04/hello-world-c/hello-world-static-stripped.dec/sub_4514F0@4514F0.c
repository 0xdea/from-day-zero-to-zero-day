__int64 __fastcall sub_4514F0(__int64 result, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  __int64 *v4; // x22
  ...
  if ( a3 )
  {
    ...
    v91 = 0;
    sub_450E44((unsigned __int64 *)(result + 16));
    v22 = *v4;
    v90 = v22;
    if ( v22 )
    {
      sub_450E44((unsigned __int64 *)v22);
    }
    else
    {
      v22 = sub_451364((__int64)v4, 0, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21);
      *v4 = v22;
      v90 = v22;
    }
    sub_4512F0(v5);
    if ( !*(_DWORD *)(v22 + 12) )
    {
      ...
      while ( 1 )
      {
        if ( *(_DWORD *)(v22 + 8) == 15 )
        {
          ...
          v54 = *(_QWORD *)(v53 + 16);
          v55 = sub_451364((__int64)v4, 1, v53, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34);
          v56 = *(_DWORD *)(v52 + 8);
          v36 = v55;
          v57 = (_QWORD *)(v55 + 16);
          v58 = v56 >> 1;
...
LABEL_35:
          ...
          *(_DWORD *)(v35 + 8) = v85;
          if ( a2 > v65 )
          {
            sub_4512F0((unsigned __int64 *)v52);
            v38 = *(_DWORD *)(v36 + 8);
            if ( !v38 )
            {
              i = 0;
          ...
          {
            sub_4512F0((unsigned __int64 *)v36);
            v38 = *(_DWORD *)(v52 + 8);
            v36 = v52;
            if ( !v38 )
            {
...
LABEL_13:
    ...
    if ( v45 == 10 )
    {
      v27 = sub_451444((__int64)v4, (__int64)&v90, &v91, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34);
      v35 = v91;
      v42 = -1;
LABEL_44:
      v68 = v90;
      v69 = sub_451364((__int64)v4, 0, v44, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34);
      v70 = v69 + 16;
      v71 = *(_DWORD *)(v68 + 8);
      v72 = v71 - (v71 >> 1);
      *(_DWORD *)(v69 + 8) = v72;
...
LABEL_53:
      ...
      *(_DWORD *)(v35 + 8) = v88;
      ...
      {
        v90 = v69;
        sub_4512F0((unsigned __int64 *)v68);
      }
      else
      {
        sub_4512F0((unsigned __int64 *)v69);
      }
LABEL_15:
      sub_4512F0((unsigned __int64 *)v35);
      v22 = v90;
      v45 = *(_DWORD *)(v90 + 8);
    }
    if ( v45 )
    {
      ...
      if ( v47 >= v45 )
        goto LABEL_23;
      if ( a2 != *(_QWORD *)(v22 + 24LL * v47 + 16) )
      {
        j_ifunc_40DD80(
          v22 + 24LL * v45 + 16 - 24LL * (v45 - v47 - 1),
          v22 + 24LL * (v45 - 1) + 16 - 24LL * (v45 - v47 - 1),
          24LL * (v45 - v47));
        goto LABEL_23;
      }
      return sub_4512F0((unsigned __int64 *)v22);
    }
    else
    {
      v50 = 0;
LABEL_23:
      v51 = (_QWORD *)(v22 + 24 * v50);
      v51[2] = a2;
      v51[3] = a3;
      v51[4] = a4;
      *(_DWORD *)(v22 + 8) = v45 + 1;
