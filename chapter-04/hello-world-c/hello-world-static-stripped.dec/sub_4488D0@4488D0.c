_BYTE *__fastcall sub_4488D0(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v83 = qword_48DD60;
  v6 = (unsigned __int8 *)sub_42F380(a2);
  v80 = v6;
  v7 = (unsigned __int8 *)sub_42F380(a3);
  v81 = v7;
  if ( v7 )
    v16 = v6 == 0;
  else
  ...
  else
  {
    ...
    *(_WORD *)(a1 + 16) = v82;
    v17 = ifunc_40DFD0(a2);
    v32 = sub_40B890(v17 + 3, v24, v25, v26, v27, v28, v29, v30, v31, v18, v19, v20, v21, v22, v23);
    *(_QWORD *)a1 = v32;
    v33 = (_BYTE *)v32;
    if ( !v32 )
      goto LABEL_37;
    v34 = ifunc_40DFD0(a3);
    v49 = sub_40B890(v34 + 3, v41, v42, v43, v44, v45, v46, v47, v48, v35, v36, v37, v38, v39, v40);
    *(_QWORD *)(a1 + 8) = v49;
    v50 = (_BYTE *)v49;
    v6 = v80;
    v51 = v81;
...
LABEL_31:
    ...
    else
    {
      ...
      v33 = 0;
      sub_40C1A0(v79, v8, v9, v10, v11, v12, v13, v14, v15);
      *(_QWORD *)a1 = 0;
    }
  }
  while ( 1 )
  {
    sub_40C1A0((unsigned __int64)v6, v8, v9, v10, v11, v12, v13, v14, v15);
    sub_40C1A0((unsigned __int64)v51, v70, v71, v72, v73, v74, v75, v76, v77);
    if ( v83 == qword_48DD60 )
      break;
    sub_412340();
LABEL_37:
