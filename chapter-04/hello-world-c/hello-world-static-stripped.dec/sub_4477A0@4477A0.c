        ...
        double a15)
{
  ...
  char *v99[3]; // [xsp+C8h] [xbp+C8h] BYREF
...
LABEL_4:
  ...
  if ( *(_WORD *)v92 != 1 )
  {
    ...
    v73 = sub_4244D0(*(unsigned __int16 *)(v19 + v20), (__int64)v98, 0xAu, 0);
    sub_4324A0(
      (const char **)v99,
      v72,
...
LABEL_98:
  ...
  while ( 1 )
  {
    ...
    v23 = (&off_4914A8)[21 * a1[6]];
    if ( v23 )
    {
      while ( !(unsigned int)sub_437560(v22, (__int64)v23) )
      {
        v23 = (__int64 *)v23[3];
        if ( !v23 )
          goto LABEL_72;
...
LABEL_72:
      if ( !*((_DWORD *)a1 + 196) )
        goto LABEL_77;
      v68 = 0;
      while ( !(unsigned int)sub_437560(v22, *(_QWORD *)(a1[97] + 8 * v68)) )
      {
...
LABEL_24:
            ...
            v37 = sub_4244D0(*v34, (__int64)v98, 0xAu, 0);
            sub_4324A0(
              (const char **)v99,
              v36,
          ...
          while ( 1 )
          {
            ...
            {
              v90 = v31;
              v46 = sub_42F240(v28, v31 + *(unsigned int *)((char *)v34 + *((unsigned int *)v34 + 3)));
              v31 = v90;
              if ( !v46 )
                goto LABEL_30;
            }
        ...
        else if ( a2 )
        {
          ...
          sub_4324A0(
            ...
            v26);
LABEL_28:
          sub_432204(0, (__int64)v99, "version lookup error");
        }
LABEL_30:
        if ( *i != 16584258 || (unsigned int)sub_42F240(v28, (unsigned __int64)"GLIBC_ABI_DT_RELR") )
        {
          v47 = i[3];
...
LABEL_49:
  v50 = sub_40CCB0(v21 + 1, 0x18u, a8, a9, a10, a11, a12, a13, a14, a15, v24, a4, a5, a6, a7);
  a1[102] = v50;
  v51 = v21 + 1;
  if ( !v50 )
  {
    ...
    sub_4323F0(v99, v89, (__int64)"cannot allocate version reference table");
    v82 = 12;
LABEL_99:
    sub_432204(v82, (__int64)v99, 0);
  }
  v52 = *((_BYTE *)a1 + 870);
  v53 = *(_QWORD *)(a1[67] + 8);
  *((_DWORD *)a1 + 206) = v51;
...
LABEL_68:
  if ( a1[9] && a1[44] && (*((_WORD *)a1 + 434) & 4) == 0 )
  {
    ...
    if ( *v84 )
    {
      while ( v85 != 1 || (unsigned int)sub_42F424(v83 + v84[1], (unsigned __int64)"libc.so.", 8u) )
      {
        v86 = v84[2];
        v84 += 2;
        v85 = v86;
      ...
      sub_4323F0(v99, v87, (__int64)"DT_RELR without GLIBC_ABI_DT_RELR dependency");
      goto LABEL_98;
    }
  }
  return 0;
