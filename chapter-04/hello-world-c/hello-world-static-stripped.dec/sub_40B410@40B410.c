        ...
        double a11)
{
  ...
  if ( v14 )
    ...
    v16 = 32;
  v17 = sub_40A0A0(a1, a2 + 32 + v16, a4, a5, a6, a7, a8, a9, a10, a11);
  v26 = (_QWORD *)v17;
  if ( !v17 )
    return 0;
  v27 = (char *)(v17 - 16);
...
LABEL_25:
  ...
  if ( (v39 & 2) != 0 )
    goto LABEL_25;
LABEL_13:
  v33 = 4LL * (a1 != &dword_490670);
  *((_QWORD *)v27 + 1) = v32 | v33 | 1;
  *(_QWORD *)&v27[v32 + 8] |= 1uLL;
  v29[1] = v29[1] & 7 | v33 | v30;
  sub_409394((__int64)a1, v29, v30, v18, v19, v20, v21, v22, v23, v24, v25);
  if ( v32 >= v16 )
  {
    v26 = v27 + 16;
...
LABEL_15:
        ...
        if ( (v34 & 0xFFFFFFFFFFFFFFF8LL) > v16 )
        {
          ...
          if ( v37 > 0x1F || *((char **)a1 + 12) == v36 || (*(_QWORD *)&v36[v38 + 8] & 1) == 0 )
          {
            *((_QWORD *)v27 + 1) = *((_QWORD *)v27 + 1) & 7LL | v16;
            if ( sub_407ED0((__int64)a1, &v27[v16], v37, v36, v38, v18, v19, v20, v21, v22, v23, v24, v25) > 0xFFFF )
              sub_408F00(a1);
          }
        }
      }
  ...
  v48 = sub_41F250("newsize >= nb && (((unsigned long) (chunk2mem (p))) % alignment) == 0", v18);
  if ( (byte_4966A0 & 1) != 0 )
    return 0;
  result = sub_4118E0(v48);
  if ( result == -1 )
    return 0;
  return result;
}
