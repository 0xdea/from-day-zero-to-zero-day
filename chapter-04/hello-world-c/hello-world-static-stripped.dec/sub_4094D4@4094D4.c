        ...
        double a11)
{
  ...
  if ( v14 > v24 )
  {
    ...
    if ( _aarch64_cas4_acq(0, 1u, (atomic_uint *)a1) )
      sub_406F40((_DWORD *)a1, v37, v38, v39, v40, v41, v42, v43, v44, v31, v32, v33, v34, v35, v36);
    sub_409394(a1, (__int64 *)a2, v14, v37, v38, v39, v40, v41, v42, v43, v44);
    result = _aarch64_swp4_rel(0, (atomic_uint *)a1);
    if ( (int)result > 1 )
      return sub_407040((void *)a1, v45, v46, v47, v48, v49, v50);
    return result;
  }
  v25 = *(_QWORD *)(a2 + v14 + 8);
  if ( v25 <= 0x10 || (v25 & 0xFFFFFFFFFFFFFFF8LL) >= *(_QWORD *)(a1 + 2184) )
  {
    ...
    {
      if ( _aarch64_cas4_acq(0, 1u, (atomic_uint *)a1) )
        sub_406F40((_DWORD *)a1, v61, v62, v63, v64, v65, v66, v67, v68, v55, v56, v57, v58, v59, v60);
      v69 = *(_QWORD *)(a2 + v14 + 8);
      if ( v69 <= 0x10 )
      {
        if ( (int)_aarch64_swp4_rel(0, (atomic_uint *)a1) > 1 )
          sub_407040((void *)a1, v78, v79, v80, v81, v82, v83);
      }
      else
      {
        v70 = *(_QWORD *)(a1 + 2184);
        ...
        if ( (int)_aarch64_swp4_rel(0, (atomic_uint *)a1) > 1 )
          sub_407040((void *)a1, v72, v73, v74, v75, v76, v77);
        if ( v71 < v70 )
          goto LABEL_14;
      }
    }
