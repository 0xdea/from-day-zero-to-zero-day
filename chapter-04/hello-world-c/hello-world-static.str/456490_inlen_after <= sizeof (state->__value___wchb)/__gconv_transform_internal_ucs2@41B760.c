        ...
        __int64 a8)
{
  ...
  __int64 v84; // x0
  __int64 v85; // x1
  unsigned __int16 **v86; // x2
  unsigned __int16 *v87; // x3
  _QWORD *v88; // x4
  __int64 *v89; // x5
  unsigned int v90; // w6
  unsigned int v91; // w7
  _QWORD *v92; // [xsp+0h] [xbp-80h]
  __int64 v93; // [xsp+0h] [xbp-80h]
  _WORD *v94; // [xsp+8h] [xbp-78h]
  int v95; // [xsp+8h] [xbp-78h]
  unsigned __int64 v96; // [xsp+8h] [xbp-78h]
  unsigned __int64 *v97; // [xsp+8h] [xbp-78h]
  unsigned int v98; // [xsp+10h] [xbp-70h]
  __int64 (__fastcall *v99)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD); // [xsp+10h] [xbp-70h]
  unsigned __int64 *v100; // [xsp+18h] [xbp-68h]
  __int64 v101; // [xsp+18h] [xbp-68h]
  __int64 (__fastcall *v102)(__int64, __int64, unsigned __int64 *, _WORD *, _QWORD, _QWORD *, _QWORD, _QWORD); // [xsp+20h] [xbp-60h]
  __int64 v103; // [xsp+20h] [xbp-60h]
  __int64 v104; // [xsp+28h] [xbp-58h]
  char v105; // [xsp+28h] [xbp-58h]
  __int64 v106; // [xsp+30h] [xbp-50h]
  unsigned __int64 v107; // [xsp+30h] [xbp-50h]
  _WORD **v108; // [xsp+38h] [xbp-48h]
  __int64 v109; // [xsp+40h] [xbp-40h]
  unsigned int v110; // [xsp+48h] [xbp-38h]
  int v111; // [xsp+48h] [xbp-38h]
  int v112; // [xsp+4Ch] [xbp-34h]
  unsigned __int64 v113; // [xsp+50h] [xbp-30h] BYREF
  unsigned __int64 v114; // [xsp+58h] [xbp-28h] BYREF
  unsigned int *v115; // [xsp+60h] [xbp-20h]
  unsigned int *v116; // [xsp+68h] [xbp-18h]
  unsigned int v117; // [xsp+70h] [xbp-10h] BYREF
  _BYTE v118[4]; // [xsp+74h] [xbp-Ch] BYREF
    ...
    if ( v26 )
    {
      ...
      if ( (unsigned __int64)a4 >= v27 - v30 + 4 )
      {
        ...
        if ( v9 >= (unsigned __int64)v25 + 2 )
        {
          ...
          {
            v33 = v30++;
            v115 = (unsigned int *)v32;
            v34 = v30 <= 3 && (unsigned __int64)a4 > v32;
            v118[v30 - 5] = *(_BYTE *)(v32++ - 1);
          }
          while ( v34 );
          v115 = &v117;
          if ( v117 > 0xFFFF )
...
LABEL_29:
  while ( 2 )
  {
    ...
    v92 = v14;
    v100 = v23;
    v102 = (__int64 (__fastcall *)(__int64, __int64, unsigned __int64 *, _WORD *, _QWORD, _QWORD *, _QWORD, _QWORD))v20;
    v104 = v19;
    v106 = v13;
    v109 = v12;
    while ( 1 )
    {
      ...
      while ( a4 != v42 )
      {
        ...
        if ( *v42 > 0xFFFF )
        {
          ...
          {
            v95 = v40;
            v69 = _gconv_transliterate(v109, v21);
            v30 = v69;
            v40 = v95;
            if ( v69 != 6 )
            {
...
LABEL_40:
      ...
      v114 = *v21;
      v94 = v41;
      v48 = v102(v104, v106, &v114, v41, 0, v39, 0, v98);
      if ( v48 == 4 )
      {
        v48 = v30;
        if ( (_DWORD)v30 == 5 )
...
LABEL_100:
      ...
      if ( (v21[2] & 8) != 0 )
      {
        ...
        v110 = v54;
        v112 = v52;
        v77 = _gconv_transliterate(v109, v21);
        v55 = v77;
        v49 = v96;
        v54 = v110;
        v52 = v112;
...
LABEL_140:
    v93 = v12;
    v97 = v23;
    v99 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))v20;
    v101 = v19;
    v103 = v13;
    v105 = v15;
    v107 = v33;
...
LABEL_158:
  ...
  *(_QWORD *)v22 += v30 - (*(_DWORD *)v11 & 7LL);
  ...
  return _gconv_transform_ucs2reverse_internal(v84, v85, v86, v87, v88, v89, v90, v91);
}
