        ...
        __int64 a8)
{
  ...
  __int64 v94; // x0
  __int64 v95; // x1
  unsigned __int8 **v96; // x2
  unsigned __int8 *v97; // x3
  unsigned int **v98; // x4
  __int64 *v99; // x5
  int v100; // w6
  unsigned int v101; // w7
  unsigned int v102; // [xsp+0h] [xbp-80h]
  __int64 v103; // [xsp+0h] [xbp-80h]
  _QWORD *v104; // [xsp+8h] [xbp-78h]
  __int64 *v105; // [xsp+8h] [xbp-78h]
  __int64 v106; // [xsp+10h] [xbp-70h]
  unsigned int *v107; // [xsp+10h] [xbp-70h]
  __int64 v108; // [xsp+18h] [xbp-68h]
  unsigned int v109; // [xsp+20h] [xbp-60h]
  __int64 *v110; // [xsp+28h] [xbp-58h]
  char v111; // [xsp+28h] [xbp-58h]
  __int64 v112; // [xsp+30h] [xbp-50h]
  int v114; // [xsp+38h] [xbp-48h]
  unsigned __int64 *v115; // [xsp+38h] [xbp-48h]
  int v116; // [xsp+44h] [xbp-3Ch]
  __int64 v117; // [xsp+50h] [xbp-30h] BYREF
  unsigned __int64 *v118; // [xsp+58h] [xbp-28h] BYREF
  char *v119; // [xsp+60h] [xbp-20h]
  unsigned __int64 *v120; // [xsp+68h] [xbp-18h]
  _DWORD v121[2]; // [xsp+70h] [xbp-10h] BYREF
...
LABEL_174:
  ...
  if ( v121[0] <= 0x7Fu )
  {
    v120 = (unsigned __int64 *)((char *)v23 + 1);
    goto LABEL_59;
  }
  if ( (unsigned int)(v121[0] - 55296) <= 0x7FF || v121[0] < 0 )
  {
    if ( !v22 )
      return 6;
    if ( (v13 & 8) == 0 )
...
LABEL_177:
      ...
      if ( v49 <= 4 )
      {
        ...
        *v107 = v91 | v49;
        do
        {
          *((_BYTE *)v107 + v93 + 3) = *((_BYTE *)v121 + v93 - 1);
          ++v93;
        }
        while ( v92 != v93 );
        return 7;
...
LABEL_175:
  ...
  else if ( v121[0] <= 0xFFFFu )
  {
    v83 = 3;
  }
  else if ( v121[0] <= 0x1FFFFFu )
  {
    v83 = 4;
  }
  else
  {
    v83 = (v121[0] > 0x3FFFFFFu) + 5LL;
  }
  if ( v21 < (unsigned __int64 *)((char *)v23 + v83) )
    return 5;
  *(_BYTE *)v23 = -256 >> v83;
  v120 = (unsigned __int64 *)((char *)v120 + v83);
  do
  {
    --v83;
    v84 = v54 & 0x3F | 0x80;
...
LABEL_29:
        ...
        if ( v35 <= 0x7F )
        {
          v120 = (unsigned __int64 *)((char *)v32 + 1);
LABEL_19:
          *(_BYTE *)v32 = v35;
          v32 = v120;
        ...
        if ( v35 - 55296 > 0x7FF && (v35 & 0x80000000) == 0 )
        {
          ...
          {
LABEL_31:
            v33 = (unsigned int *)v119;
            v34 = 5;
            goto LABEL_21;
          }
          *(_BYTE *)v32 = -256 >> v41;
          v120 = (unsigned __int64 *)((char *)v120 + v41);
          do
          {
            --v41;
            v42 = v35 & 0x3F | 0x80;
        ...
        {
          v114 = v13;
          v34 = _gconv_transliterate(v112, v26);
          v13 = v114;
          if ( v34 != 6 )
          {
            v33 = (unsigned int *)v119;
...
LABEL_27:
  ...
  *v31 = (unsigned __int64)v28;
  ...
  while ( v29 >= (unsigned __int64)(v28 + 4) )
  {
    ...
    if ( *(_DWORD *)v28 <= 0x7Fu )
    {
      v120 = (unsigned __int64 *)((char *)v58 + 1);
LABEL_68:
      *(_BYTE *)v58 = v60;
      v58 = v120;
      v28 = v119 + 4;
    ...
    if ( v60 - 55296 > 0x7FF && (v60 & 0x80000000) == 0 )
    {
      ...
      if ( v38 < (unsigned __int64 *)((char *)v58 + v73) )
        goto LABEL_90;
      *(_BYTE *)v58 = -256 >> v73;
      v120 = (unsigned __int64 *)((char *)v120 + v73);
      do
      {
        --v73;
        v74 = v60 & 0x3F | 0x80;
    ...
    if ( !v110 )
      break;
    if ( ((_DWORD)v26[2] & 8) == 0
      || (v115 = v38, v85 = _gconv_transliterate(v112, v26), v59 = v85, v38 = v115, v58 = v120, v85 == 6) )
    {
      if ( ((unsigned __int8)v32 & 2) == 0 )
      {
        v32 = v31;
        v30 = (unsigned __int64 *)v119;
        goto LABEL_88;
      }
      v28 = v119 + 4;
      v59 = 6;
...
LABEL_186:
  ...
  return _gconv_transform_utf8_internal(v94, v95, v96, v97, v98, v99, v100, v101);
}
