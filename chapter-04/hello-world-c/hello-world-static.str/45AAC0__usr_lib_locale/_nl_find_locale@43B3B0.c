...
char **__fastcall nl_find_locale(const char *a1, __int64 a2, __int64 a3, const char **a4)
{
  ...
  int v71; // w1
  __int64 v72; // x1
  __int64 v73; // [xsp+0h] [xbp-30060h] BYREF
  _BYTE v74[992]; // [xsp+20h] [xbp-30040h] BYREF
  __int64 v75; // [xsp+400h] [xbp-2FC60h]
  _QWORD v76[4]; // [xsp+10000h] [xbp-20060h] BYREF
  _BYTE v77[992]; // [xsp+10020h] [xbp-20040h] BYREF
  __int64 v78; // [xsp+10400h] [xbp-1FC60h]
  __int64 v79; // [xsp+20000h] [xbp-10060h] BYREF
  char v80[992]; // [xsp+20020h] [xbp-10040h] BYREF
  __int64 v81; // [xsp+20400h] [xbp-FC60h]
  ...
  if ( !*v83 )
  {
    v14 = (unsigned __int8 *)getenv("LC_ALL", a2, a3, &_stack_chk_guard, 0);
    v83 = (const char *)v14;
    if ( v14 && *v14
      || (v19 = (unsigned __int8 *)getenv(
                                     &nl_category_names[(unsigned __int8)nl_category_name_idxs[v5]],
                                     (unsigned __int8)nl_category_name_idxs[v5],
                                     v15,
                                     v16,
                                     v17),
          (v83 = (const char *)v19) != 0)
      && *v19 )
    {
    ...
    {
      v18 = (unsigned __int8 *)getenv("LANG", v20, v21, v22, v23);
      v83 = (const char *)v18;
      if ( !v18 )
      {
LABEL_28:
...
LABEL_11:
  v12 = (unsigned __int8 *)v83;
  *a4 = v83;
  if ( a1 )
  {
    v24 = (unsigned __int8 *)nl_expand_alias((__int64)v12);
    v83 = (const char *)v24;
  }
  else
  {
    result = (char **)nl_load_locale_from_archive(v5, (unsigned __int8 **)a4);
    if ( result )
      return result;
    v83 = (const char *)nl_expand_alias((__int64)*a4);
    if ( !v83 )
    {
      a1 = "/usr/lib/locale";
      v7 = 16;
    ...
    result = (char **)nl_load_locale_from_archive(v5, (unsigned __int8 **)&v83);
    if ( result )
      return result;
    v24 = (unsigned __int8 *)v83;
    v7 = 16;
    a1 = "/usr/lib/locale";
  }
  if ( !v24 )
...
LABEL_64:
  ...
  v26 = v25 + 1;
  v27 = (v25 + 16) & 0xFFF0;
  v28 = (__int64 *)&v82[-((v25 + 16) & 0xFFFFFFFFFFFF0000LL)];
  if ( v82 != (_BYTE *)v28 )
  {
    do
      v81 = 0;
  ...
  if ( v27 >= 0x400uLL )
    v81 = 0;
  v29 = _memcpy_chk(v80, v24, v26);
  v30 = nl_explode_name(v29, &v84, &v85, &v86, &v87, &v88);
  v31 = v30;
  if ( v30 == -1 )
    return 0;
  v32 = &nl_category_names[(unsigned __int8)nl_category_name_idxs[v5]];
  l10nflist = nl_make_l10nflist(
                &nl_locale_file_list[v5],
                (unsigned __int64)a1,
                v7,
                v30,
                v84,
...
LABEL_69:
    ...
    *v48 = 0;
    ...
    while ( v54 );
    if ( (unsigned int)_gconv_compare_alias((__int64)v74, (__int64)v77) )
      return 0;
    v34 = (_QWORD *)l10nflist[2];
  }
  if ( !*v34 )
  ...
  if ( !v85 || (unsigned int)strcasecmp_l(v85, "TRANSLIT", nl_C_locobj) )
  {
