        ...
        __int64 a8)
{
  ...
  __int64 (__fastcall *v92)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD); // [xsp+18h] [xbp-68h]
  ...
  if ( a7 )
  {
    if ( !a5 )
    {
      **(_QWORD **)(a2 + 32) = 0;
      if ( (*(_DWORD *)(a2 + 16) & 1) != 0 )
        return 0;
      return ((__int64 (__fastcall *)(__int64, __int64, _QWORD, _QWORD, _QWORD, _QWORD *, _QWORD, __int64))v18)(
               a1 + 104,
               v11,
               0,
               0,
  ...
  v8 = *v21;
  v103 = 0;
  if ( !(_DWORD)a8 || (v23 = *(unsigned int **)(a2 + 32), (v24 = *v23 & 7) == 0) )
  {
    v36 = *a3;
    v37 = 0;
    goto LABEL_28;
...
LABEL_149:
  ...
  while ( v28 < (*v23 & 7) );
  if ( a4 < (unsigned int *)((char *)v25 - v28 + 4) )
  {
    *a3 = a4;
    v77 = (char *)((char *)a4 - (char *)v25 + v28);
    if ( (unsigned __int64)v77 > 4 )
      goto LABEL_149;
    v78 = (unsigned int *)((char *)v25 + 1);
    if ( v28 < (unsigned __int64)v77 )
    {
      do
      {
        v105 = v78;
  ...
  do
  {
    ...
    v32 = v28 <= 3 && (unsigned __int64)a4 > v30;
...
LABEL_137:
  ...
  v89 = v22;
  v90 = v23;
  v92 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))v18;
  v94 = v10 + 104;
  v96 = v11;
  v98 = v13;
  v99 = v31;
...
LABEL_72:
      ...
      if ( (unsigned __int64)v72 <= 4 )
      {
        ...
        if ( v72 )
        {
          do
          {
            v74[(_QWORD)(v73 + 1)] = v74[(_QWORD)v71];
            ++v74;
          }
          while ( v72 != v74 );
