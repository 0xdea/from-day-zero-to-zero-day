        ...
        double a16)
{
  ...
  int v94; // [xsp+80h] [xbp+60h]
  __int64 v95; // [xsp+88h] [xbp+68h]
  int v96; // [xsp+88h] [xbp+68h]
  ...
  unsigned __int64 v105; // [xsp+C8h] [xbp+A8h] BYREF
...
LABEL_10:
    v30 = a4;
    for ( i = do_lookup_x(a1, v25, &v105, *a3, &v106, v29, v95, (__int64)a5, a7, a8, a6, a2);
          !i;
          i = do_lookup_x(a1, v25, &v105, *a3, &v106, v33, 0, (__int64)a5, a7, a8, a6, a2) )
    {
      v35 = v30[1];
      ++v30;
      v33 = v35;
    ...
    if ( v37 && (*(_BYTE *)(v37 + 5) & 3) == 3 )
    {
      ...
      if ( !*a4 )
        goto LABEL_94;
      while ( !(unsigned int)do_lookup_x(a1, v25, &v105, v37, (__int64 *)&v108, v33, v95, (__int64)a5, a7, a8, 1u, 0) )
      {
        v43 = v42[1];
        ++v42;
        v33 = v43;
