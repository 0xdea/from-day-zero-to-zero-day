char **__fastcall setlocale(int a1, const char *a2)
{
  ...
  const char **v47; // [xsp+18h] [xbp-F8h]
  const char *v48; // [xsp+28h] [xbp-E8h] BYREF
  __int64 v49; // [xsp+30h] [xbp-E0h] BYREF
  _QWORD v50[13]; // [xsp+38h] [xbp-D8h] BYREF
  const char *v51[13]; // [xsp+A0h] [xbp-70h] BYREF
  ...
  if ( (_DWORD)v4 != 6 )
  {
    ...
    if ( v13 )
    {
      locale = nl_find_locale(v48, v49, (unsigned int)v4, v51);
      v15 = locale;
      if ( !locale )
        goto LABEL_79;
      v5 = v51[0];
    ...
    if ( v5 == "C" || (v51[0] = (const char *)strdup(v5)) != 0 )
    {
      v16 = (char *)new_composite_name((unsigned int)v4, v51);
      if ( v16 )
      {
        if ( v13 )
        {
    ...
    while ( v22 )
    {
      ...
      if ( v25 )
      {
        ...
        if ( v26 != "C" )
        {
          v52 = v2;
          v53 = v3;
          v27 = nl_global_locale[(int)v22 + 16];
