unsigned __int64 __fastcall sysmalloc(unsigned __int64 a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  __int64 *v60; // [xsp+8h] [xbp-28h]
  unsigned __int64 v61; // [xsp+8h] [xbp-28h]
  __int64 *v62; // [xsp+8h] [xbp-28h]
  __int64 *v63; // [xsp+8h] [xbp-28h]
  __int64 *v64; // [xsp+8h] [xbp-28h]
  unsigned __int64 v65; // [xsp+10h] [xbp-20h]
  ...
  unsigned __int64 v71; // [xsp+20h] [xbp-10h] BYREF
  __int64 v72; // [xsp+80h] [xbp+50h]
  unsigned __int64 v73; // [xsp+88h] [xbp+58h]
  ...
  if ( a2 == (_QWORD *)&main_arena )
  {
    ...
    if ( (_always_fail_morecore & 1) != 0
      || (v64 = v12,
          v69 = (char *)v12 + (v13 & 0xFFFFFFFFFFFFFFF8LL),
          v27 = sbrk(v36),
          v12 = v64,
          v15 = (unsigned __int64)v69,
...
LABEL_112:
      if ( !qword_490600
        || (v60 = v12,
            v65 = v15,
            v37 = sysmalloc_mmap_fallback_constprop_0(&v71, a1, v14, qword_490600, qword_490600, dword_490608),
            v12 = v60,
            v15 = v65,
            v27 = v37,
            v37 == -1) )
      {
        v63 = v12;
        v68 = v15;
        v27 = sysmalloc_mmap_fallback_constprop_0(&v71, a1, v14, 0x100000u, v10, 0);
        v12 = v63;
        v15 = v68;
        if ( v27 == -1 )
          goto LABEL_62;
...
LABEL_109:
            ...
            return int_malloc(v55, v56, v57, v58);
          }
LABEL_108:
...
LABEL_82:
          ...
          if ( (_always_fail_morecore & 1) != 0 || (v70 = v12, v61 = v27, v39 = sbrk(0), v12 = v70, v39 == -1) )
          {
            v27 = qword_4906D0;
            v26 = qword_490EF8;
            goto LABEL_19;
...
LABEL_18:
  ...
  if ( v30 )
  {
    ...
    *v30 = a2;
    ...
    a2[273] = v26;
    v30[7] = (v31 - 48) | 1;
    *(__int64 *)((char *)v59 + v32 + 24) = 1;
    if ( v32 > 0x1F )
    {
      *(_OWORD *)((char *)v59 + v32 + 8) = xmmword_45A910;
      v59[1] = v32 | 5;
      int_free((__int64)a2, v59, 1);
      v27 = a2[12];
      v26 = a2[273];
    }
    else
