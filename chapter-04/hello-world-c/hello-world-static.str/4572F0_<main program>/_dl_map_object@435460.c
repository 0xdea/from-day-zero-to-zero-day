...
LABEL_15:
    ...
    if ( (dl_debug_mask & 0x40) != 0 )
    {
      if ( a1 )
      {
        ...
        {
LABEL_18:
          v55 = (const char *)expand_dynamic_string_token(a1, a2);
          v19 = v55;
          if ( !v55 )
            goto LABEL_24;
LABEL_19:
...
LABEL_31:
        ...
        v30 = (__int64 *)a1;
        v48 = 0;
        for ( i = cache_rpath(v30, v30 + 110, 15, "RPATH"); ; i = cache_rpath(v30, v30 + 110, 15, "RPATH") )
        {
          if ( (i & 1) != 0 )
          {
            LODWORD(v20) = open_path_isra_0((__int64)a2, v50, a5, v30 + 110, (__int64 *)&v55, (__int64)v57, a1, &v54);
            if ( (_DWORD)v20 != -1 )
              goto LABEL_34;
            v48 |= v51 == v30;
          }
...
LABEL_42:
            ...
            if ( (a5 & 0x4000000) != 0 && _libc_enable_secure
              || dl_inhibit_cache
              || (cache_lookup = (const char *)dl_load_cache_lookup(a2)) == 0 )
            {
LABEL_91:
              v36 = (__int64 *)a1;
              if ( a1 )
...
LABEL_71:
          ...
          if ( !a1 )
          {
            ...
            if ( (a5 & 0x4000000) != 0 )
            {
              ...
              {
                cache_lookup = (const char *)dl_load_cache_lookup(a2);
                if ( cache_lookup )
                  goto LABEL_101;
              }
            }
...
LABEL_116:
  ...
  add_name_to_object_isra_0(v13[7], v16);
