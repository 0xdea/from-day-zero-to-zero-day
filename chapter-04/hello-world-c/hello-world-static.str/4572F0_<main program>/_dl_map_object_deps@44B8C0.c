__int64 __fastcall dl_map_object_deps(__int64 a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  unsigned __int64 v124; // [xsp+300B8h] [xbp+70h]
  ...
  const char *v143; // [xsp+30148h] [xbp+100h]
...
LABEL_134:
      ...
      v91 = v127;
      StatusReg = (unsigned __int64)&v104;
      v92 = v127[1];
      v104 = *v127;
      v105 = v92;
      v106 = v127[2];
...
LABEL_60:
        ...
        if ( v58 >= 0x400uLL )
          v108 = 0;
        v60 = (const char *)dl_dst_substitute(v15, v33, v107);
        if ( !*v60 )
        {
          v20 = *v31;
          if ( *v31 == 2147483645 )
...
LABEL_38:
  ...
  if ( v43 >= 0x400uLL )
    v114 = 0;
  v17 = (const char *)dl_dst_substitute(v15, v33, v113);
  if ( !*v17 )
  {
    if ( (*v128 & 1) == 0 )
      goto LABEL_52;
