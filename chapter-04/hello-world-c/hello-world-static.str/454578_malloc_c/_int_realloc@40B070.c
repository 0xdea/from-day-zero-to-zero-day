__int64 __fastcall int_realloc(_QWORD *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
...
LABEL_32:
        ...
        return _libc_mtag_tag_region(_X0, (*(_QWORD *)(v34 + 8) & 0xFFFFFFFFFFFFFFF8LL) - 16);
      }
    }
    else if ( (*(_QWORD *)(v14 + v16 + 8) & 1) == 0 && a4 <= v12 + v16 )
    {
      v12 += v16;
      v7 = (_BYTE *)&unk_496000;
      unlink_chunk_isra_0(a2 + v13);
      goto LABEL_11;
    }
    v21 = int_malloc((unsigned __int64)a1, a4 - 15, v13, a4);
    v19 = v21;
    if ( !v21 )
      return v19;
    v7 = &unk_496000;
    ...
    if ( (mtag_enabled & 1) != 0 )
    {
      ...
      if ( (mtag_enabled & 1) != 0 )
      {
        ...
        v19 = _libc_mtag_tag_region(_X0, (*(_QWORD *)(v42 + 8) & 0xFFFFFFFFFFFFFFF8LL) - 16);
      }
    }
    else
    {
...
LABEL_11:
    ...
    if ( v12 - v6 <= 0x1F )
    {
      *(_QWORD *)(a2 + 8) = *(_QWORD *)(a2 + 8) & 7LL | v8 | v12;
      *(_QWORD *)(a2 + v12 + 8) |= 1uLL;
      goto LABEL_13;
    }
LABEL_22:
    v24 = a2 + v6;
    if ( (v18 & 1) != 0 )
      v24 = _libc_mtag_tag_region(a2 + v6, v4);
    *(_QWORD *)(a2 + 8) = *(_QWORD *)(a2 + 8) & 7LL | v8 | v6;
    *(_QWORD *)(v24 + 8) = v4 | v8 | 1;
    *(_QWORD *)(v24 + v4 + 8) |= 1uLL;
    int_free(v5, v24, 1);
LABEL_13:
    v19 = a2 + 16;
    if ( (v7[1697] & 1) == 0 )
...
LABEL_37:
  v46 = _libc_assert_fail("(unsigned long) (newsize) >= (unsigned long) (nb)", "malloc.c", 5006, "_int_realloc");
  return int_memalign(v46);
}
