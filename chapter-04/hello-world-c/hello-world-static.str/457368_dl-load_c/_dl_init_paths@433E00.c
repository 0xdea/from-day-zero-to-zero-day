  ...
  *v17 = 0;
  ...
  if ( v25 )
  {
    ...
    if ( (*((_BYTE *)v23 + 870) & 0x20) != 0 )
      v26 = *v23;
    decompose_rpath(v23 + 127, *(_QWORD *)(v23[13] + 8) + *(_QWORD *)(v25 + 8) + v26, v23, "RUNPATH");
    *((_DWORD *)v23 + 256) = 0;
    v23[110] = -1;
  }
  else
  {
    ...
    if ( v31 )
    {
      ...
      if ( (*((_BYTE *)v23 + 870) & 0x20) != 0 )
        v32 = *v23;
      decompose_rpath(v23 + 110, *(_QWORD *)(v23[13] + 8) + *(_QWORD *)(v31 + 8) + v32, v23, "RPATH");
      *((_DWORD *)v23 + 222) = 0;
    }
    else
    {
...
LABEL_38:
  ...
  fillin_rpath_isra_0(v39, _rtld_env_path_list, ":;", a2, 0, v23);
