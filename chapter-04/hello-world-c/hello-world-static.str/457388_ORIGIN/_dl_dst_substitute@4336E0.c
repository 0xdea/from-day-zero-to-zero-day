_BYTE *__fastcall dl_dst_substitute(__int64 a1, unsigned __int8 *a2, _BYTE *a3)
{
  _BYTE *v3; // x20
  _BOOL4 v7; // w26
...
LABEL_12:
    v8 += v10;
    v3 = (_BYTE *)stpcpy(v3, v11);
    v9 = *v8;
  }
  while ( *v8 );
LABEL_13:
  if ( !v7 || (is_trusted_path_normalize(a3, v3 - a3) & 1) != 0 )
    *v3 = 0;
  else
    *a3 = 0;
  return a3;
