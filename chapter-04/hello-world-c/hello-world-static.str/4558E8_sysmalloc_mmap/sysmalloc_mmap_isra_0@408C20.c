__int64 __fastcall sysmalloc_mmap_isra_0(unsigned __int64 a1, __int64 a2, int a3)
{
  ...
  if ( a1 >= v3 )
    return -1;
  v6 = mmap64(0, (a2 + 7 + a1) & -a2, mtag_mmap_flags | 3u, a3 | 0x22u, 0xFFFFFFFFLL, 0);
  if ( v6 == -1 )
    return -1;
  if ( (a3 & 0x40000) == 0 && qword_4905F8 - 1 < v3 )
  {
    ...
    {
      v11 = v3 + ((dl_pagesize - 1) & v6);
      v12 = -dl_pagesize & v6;
    }
    madvise(v12, v11, 14);
  }
  _set_vma_name(v6, v3, " glibc: malloc");
  if ( (v6 & 0xF) != 0 )
  {
    v13 = _libc_assert_fail(
            "((INTERNAL_SIZE_T) chunk2mem (mm) & MALLOC_ALIGN_MASK) == 0",
            "malloc.c",
            2448,
            "sysmalloc_mmap");
    return systrim_constprop_0(v13);
  }
  else
  {
    *(_QWORD *)v6 = 0;
