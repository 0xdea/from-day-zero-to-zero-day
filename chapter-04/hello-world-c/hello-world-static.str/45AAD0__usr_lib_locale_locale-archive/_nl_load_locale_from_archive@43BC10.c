__int64 __fastcall nl_load_locale_from_archive(int a1, unsigned __int8 **a2)
{
  ...
  _QWORD *v59; // x0
  _QWORD *v60; // x23
  __int64 v61; // [xsp+0h] [xbp-10100h] BYREF
  _BYTE v62[1008]; // [xsp+10h] [xbp-100F0h] BYREF
  __int64 v63; // [xsp+400h] [xbp-FD00h]
  _BYTE v64[16]; // [xsp+10000h] [xbp-100h] BYREF
  __int64 v65; // [xsp+10010h] [xbp-F0h]
  int v66; // [xsp+1001Ch] [xbp-E4h]
  _BYTE v67[208]; // [xsp+10028h] [xbp-D8h] BYREF

  v66 = a1;
  v3 = *a2;
  sysconf(30, (__int64)&_stack_chk_guard, 0);
...
LABEL_29:
        ...
        v18 = *(_DWORD *)(v10 + 16);
        v65 = *(unsigned int *)(v10 + 8);
        if ( v18 > 2 )
        {
          v19 = v17 % (v18 - 2) + 1;
          v20 = v17 % v18;
LABEL_17:
          v21 = (_DWORD *)(v10 + v65 + 12 * v20);
          while ( 1 )
          {
            v22 = v21[1];
            if ( !v22 )
                      ...
                      if ( v53 )
                      {
                        ...
                        *v52 = v58;
                        do
                        {
                          ...
                          v59 = nl_intern_locale_data(v24, *(int **)v27, *((_QWORD *)v27 + 1), v54, v55, v56);
                          *v57 = v59;
                          if ( v59 )
                          {
                            *v59 = v52[1];
