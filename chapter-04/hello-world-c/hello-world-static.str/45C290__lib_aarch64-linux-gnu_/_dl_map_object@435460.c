__int64 *__fastcall dl_map_object(__int64 a1, char *a2, __int64 a3, int a4, int a5, unsigned __int64 a6)
{
  ...
  unsigned int v47; // [xsp+84h] [xbp+74h]
...
LABEL_25:
                ...
                v33 = strdup(a2);
                v34 = v33;
                if ( !v33 || (v35 = dl_new_object(v33, a2, v10, a1, (unsigned int)a5, a6), (v13 = (__int64 *)v35) == 0) )
                {
                  free(v34);
