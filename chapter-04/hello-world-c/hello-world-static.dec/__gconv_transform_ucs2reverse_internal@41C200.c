        ...
        unsigned int a8)
{
  ...
  unsigned int v21; // w0
  int v22; // w3
  unsigned __int8 *v23; // x4
  unsigned __int8 *v24; // x7
...
LABEL_60:
          ...
          while ( v65 && (v42 & 2) != 0 )
          {
            ++*v65;
LABEL_61:
            if ( (unsigned __int16 *)a4 == v43 )
              goto LABEL_68;
            v48 = v43 + 1;
            if ( a4 < (unsigned __int64)(v43 + 1) )
              goto LABEL_68;
            v44 = v45 + 1;
            if ( v38 < (unsigned __int64)(v45 + 1) )
            {
              *a3 = (unsigned __int64)v43;
              if ( (_DWORD *)v38 == v45 )
              {
                if ( (_DWORD *)v38 == v18 )
                  goto LABEL_85;
...
LABEL_68:
    ...
    if ( !a5 )
    {
      ...
      if ( (*v20 & 7) <= 4 )
      {
        ...
        if ( a4 >= (unsigned __int64)v24 )
        {
          if ( v19 < (unsigned __int64)(v18 + 1) )
            return 5;
          v26 = (unsigned __int16)__rev16(*((unsigned __int8 *)v20 + 4) | (*v23 << 8));
