__int64 __fastcall dl_add_to_slotinfo(
        __int64 result,
        char a2,
        double a3,
        double a4,
        ...
        void *a15)
{
  ...
  if ( v15 )
  {
    _libc_assert_fail("idx == 0", "dl-tls.c", 1044, "_dl_add_to_slotinfo");
LABEL_12:
    dl_signal_error(12, "dlopen", 0, "cannot create TLS data structures");
  }
  v21 = (_QWORD *)malloc(0x3F0u, a3, a4, a5, a6, a7, a8, a9, a10, v19, 0, a12, a13, a14, a15);
  v22 = (unsigned __int64)v21;
  if ( !v21 )
    goto LABEL_12;
  *v21 = 62;
  v21[1] = 0;
  result = memset(v21 + 2, 0, 992);
...
LABEL_5:
  if ( (a2 & 1) != 0 )
  {
    ...
    *(_QWORD *)(v20 + 16) = dl_tls_generation + 1;
  }
  return result;
}
