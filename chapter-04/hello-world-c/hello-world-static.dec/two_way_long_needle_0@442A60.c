__int64 __fastcall two_way_long_needle_0(__int64 a1, __int64 a2, int8x16_t *a3, unsigned __int64 a4)
{
  ...
  _QWORD v48[256]; // [xsp+8h] [xbp-808h] BYREF
  __int64 v49; // [xsp+808h] [xbp-8h] BYREF
...
LABEL_16:
  ...
  do
    *v25++ = a4;
  while ( v25 != (unsigned __int64 *)&v49 );
  v26 = a3;
  if ( a4 )
  {
    do
  ...
  v29 = a2 - a4;
  if ( !(unsigned int)memcmp(a3, (int8x16_t *)((char *)a3 + v16), v23) )
  {
    v30 = a4 - v16;
    v31 = 1 - v23;
    v32 = 0;
    ...
    {
      v37 = a1 + v33;
      v36 = v48[*(unsigned __int8 *)(a1 + v33 + v8)];
      if ( v36 )
        break;
      if ( v23 < v32 )
        v38 = v32;
...
LABEL_28:
  ...
  {
    v37 = a1 + v43;
    v45 = v48[*(unsigned __int8 *)(a1 + v43 + v8)];
    if ( v45 )
    {
      v43 += v45;
      goto LABEL_57;
