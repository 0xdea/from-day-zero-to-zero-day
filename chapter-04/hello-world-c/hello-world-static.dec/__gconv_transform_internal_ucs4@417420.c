        ...
        unsigned int a8)
{
  ...
  unsigned __int64 v61; // [xsp+20h] [xbp-30h]
  __int64 (__fastcall *v62)(__int64, unsigned __int64, unsigned __int64 *, unsigned __int64, _QWORD, __int64 *, _QWORD, _QWORD); // [xsp+28h] [xbp-28h]
  ...
  if ( !a7 )
  {
    ...
    v10 = v19;
    v15 = a3;
    v62 = (__int64 (__fastcall *)(__int64, unsigned __int64, unsigned __int64 *, unsigned __int64, _QWORD, __int64 *, _QWORD, _QWORD))v9;
    v63 = v8;
    while ( 1 )
    {
      v24 = 0;
      ...
      *v15 = v31;
      ...
      if ( v30 <= v10 )
        goto LABEL_30;
      v65 = *v21;
      v33 = v62(v63, v61, &v65, v30, 0, v22, 0, a8);
      if ( v33 == 4 )
      {
        if ( (_DWORD)a6 != 5 )
        {
...
LABEL_28:
  ...
  if ( v12 )
  {
    _libc_assert_fail("outbufstart == NULL", "../iconv/skeleton.c", 350, "__gconv_transform_internal_ucs4");
    goto LABEL_84;
  }
  **(_QWORD **)(v10 + 32) = 0;
  if ( (*(_DWORD *)(v10 + 16) & 1) != 0 )
    return 0;
  return ((__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD, _QWORD, _QWORD, __int64, _QWORD))v9)(
           v8,
           v16,
           0,
           0,
