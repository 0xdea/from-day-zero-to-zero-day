    ...
    if ( (v6 & 1) == 0 )
    {
      ...
      while ( 1 )
      {
        while ( (*(_DWORD *)v23 & 0xFFFFFFFD) != 0 )
        {
          if ( v24 )
            goto LABEL_8;
          v46 = atomic_load((unsigned int *)rwlock);
          v24 = v46 & 1;
        }
      ...
      if ( rwlock->__flags )
      {
        ...
        if ( nr_readers )
        {
          v47 = _dl___aarch64_swp4_relax(0, p_writer_wakeup);
          while ( 1 )
          {
            v48 = _dl___aarch64_cas4_rel(
                    nr_readers,
          ...
          if ( (v47 & 2) != 0 )
          {
            v52 = linux_eabi_syscall(__NR_futex, p_writer_wakeup, (void *)(v25 ^ 0x81), (void *)1, 0, v49, v50, v51);
          ...
          if ( v20 )
          {
              ...
              || (((_DWORD)v44 + 22) & 0xFFFFFFF7) == 0 )
            {
              if ( ((unsigned __int8)v43 & 4) == 0 )
                return 110;
              v45 = linux_eabi_syscall(__NR_futex, rwlock, (void *)(v25 ^ 0x81), (void *)0x7FFFFFFF, 0, v43, v33, v34);
...
LABEL_31:
  ...
  if ( flags )
  {
    v53 = rwlock->__nr_readers;
    do
    {
      v54 = v53 - 1;
      if ( v53 == -2147483647 )
        v54 = 0;
      v55 = _aarch64_cas4_acq(v53, v54, (atomic_uint *)((char *)&rwlock->__align + 4));
      v20 = v55 == v53;
      v53 = v55;
    }
    while ( !v20 );
