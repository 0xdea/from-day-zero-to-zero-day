__int64 __fastcall hack_digit(__int64 a1)
{
  ...
  if ( !v2 )
  {
    ...
    v17 = 8 * v3 - 8;
    v18 = *(_QWORD *)(v4 + v17);
    *(_QWORD *)(v4 + v17) = _mpn_mul_1(v4, v16, v3 - 1, 10);
    return (unsigned __int8)(v18 + 48);
  }
  if ( v2 > v3 )
  {
    v5 = 48;
    v6 = _mpn_mul_1(*(_QWORD *)(a1 + 16), *(_QWORD *)(a1 + 16), v3, 10);
    if ( v6 )
    {
LABEL_6:
      v8 = *(_QWORD *)(a1 + 16);
  ...
  v10 = _mpn_divrem(*(_QWORD *)(a1 + 48), 0, *(_QWORD *)(a1 + 16), v3, *(_QWORD *)(a1 + 32));
  v11 = *(__int64 **)(a1 + 48);
  ...
  *(_QWORD *)(a1 + 24) = v12;
  if ( v12 )
  {
    ...
    v6 = _mpn_mul_1(v14, v14, *(_QWORD *)(a1 + 24), 10);
    if ( v6 )
      goto LABEL_6;
    return v5;
  }
