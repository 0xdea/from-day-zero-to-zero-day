unsigned __int64 __fastcall btree_remove(__int64 a1, unsigned __int64 a2)
{
  ...
  version_lock_lock_exclusive((unsigned __int64 *)(a1 + 16));
  v5 = *(unsigned __int64 **)a1;
  if ( !*(_QWORD *)a1 )
  {
    version_lock_unlock_exclusive(v3);
    return 0;
  }
  version_lock_lock_exclusive(*(unsigned __int64 **)a1);
  version_lock_unlock_exclusive(v3);
  if ( !*((_DWORD *)v5 + 3) )
  {
...
LABEL_9:
      v11 = &v5[2 * v7];
      v12 = v11[3];
      version_lock_lock_exclusive((unsigned __int64 *)v12);
      if ( *(_DWORD *)(v12 + 12) )
        v13 = 5;
      else
        v13 = 7;
      if ( *(_DWORD *)(v12 + 8) >= v13 )
      {
        ...
        version_lock_unlock_exclusive(v55);
        continue;
      }
      if ( v7 )
      {
        ...
        {
          v15 = v11[3];
          version_lock_lock_exclusive((unsigned __int64 *)v5[2 * --v7 + 3]);
          v16 = *(_DWORD *)(v14 + 8);
          v17 = *(_DWORD *)(v14 + 12);
          v18 = *(_DWORD *)(v15 + 8);
          v19 = v16 + v18;
      ...
      v14 = v11[3];
      version_lock_lock_exclusive((unsigned __int64 *)v15);
      v18 = *(_DWORD *)(v15 + 8);
      v16 = *(_DWORD *)(v14 + 8);
      v17 = *(_DWORD *)(v14 + 12);
      v19 = v16 + v18;
...
LABEL_22:
          ...
          *(_DWORD *)(v15 + 12) = 2;
          ...
          while ( !v40 );
          version_lock_unlock_exclusive((unsigned __int64 *)v15);
...
LABEL_65:
              ...
              version_lock_unlock_exclusive((unsigned __int64 *)v14);
              continue;
            }
            goto LABEL_57;
          }
