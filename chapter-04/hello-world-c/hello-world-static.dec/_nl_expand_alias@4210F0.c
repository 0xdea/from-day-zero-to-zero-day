...
LABEL_5:
  ...
  {
LABEL_6:
    for ( i = 0; ; i = read_alias_file(v23, (int)v18 - (int)v23) )
    {
      v18 = (_BYTE *)locale_alias_path_1;
      if ( i )
        goto LABEL_5;
      v19 = *(unsigned __int8 *)locale_alias_path_1;
      if ( !*(_BYTE *)locale_alias_path_1 )
      {
LABEL_20:
        if ( (_DWORD)i )
          locale_alias_path_1 = (__int64)v18;
        v28 = 0;
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    v40 = strcasecmp_l(a1, *v39, nl_C_locobj);
    if ( v40 < 0 )
    {
      v16 = (v37 + v16) >> 1;
      goto LABEL_29;
...
LABEL_29:
  ...
  if ( (int)_aarch64_swp4_rel(0, (atomic_uint *)lock_0) <= 1 )
    return v28;
LABEL_33:
  _lll_lock_wake_private(lock_0, v29, v30, v31, v32, v33, v34);
  return v28;
}
