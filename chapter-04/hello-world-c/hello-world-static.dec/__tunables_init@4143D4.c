__int64 __fastcall _tunables_init(unsigned __int8 **a1)
{
  __int64 result; // x0
                ...
                if ( *v17 )
                {
                  while ( 1 )
                  {
                    ...
                    if ( !v24 )
                    {
                      ...
                      result = tunable_initialize((__int64)&tunable_list[i], v11, v25);
                      if ( a1 )
                        goto LABEL_3;
                      return result;
                    }
