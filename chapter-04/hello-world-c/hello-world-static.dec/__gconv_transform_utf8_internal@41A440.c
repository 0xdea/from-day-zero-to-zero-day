        ...
        unsigned int a8)
{
  ...
  if ( !a7 )
  {
    ...
    if ( !a5 )
    {
      ...
      while ( v40 != 6 && a4 > (unsigned __int64)v45 );
      v48 = v95;
      if ( v95 <= 0x7Fu )
      {
        *v10 = v95;
...
LABEL_22:
            v27 = &v22[v25];
            v28 = 1;
            if ( a4 < (unsigned __int64)&v22[v25] )
              goto LABEL_49;
            do
            {
LABEL_25:
...
LABEL_16:
          ...
          if ( (v23 & 0xF0) == 0xE0 )
          {
            ...
            v26 = 3;
            v28 = 1;
            if ( a4 >= (unsigned __int64)(v22 + 3) )
              goto LABEL_25;
LABEL_49:
            for ( i = 1; a4 > (unsigned __int64)v24; v24 = &v22[++i] )
            {
              if ( (*v24 & 0xC0) != 0x80 )
                break;
            }
            if ( (unsigned __int8 *)a4 != v24 )
              goto LABEL_44;
            *a3 = v22;
            v11 = 7;
            if ( !a5 )
...
LABEL_118:
          ...
          {
            i = v34;
            if ( a4 <= (unsigned __int64)&v22[v34] || (v22[v34] & 0xC0) != 0x80 )
              break;
            if ( ++v34 == 6 )
            {
              i = 5;
...
LABEL_201:
                    ...
                    else
                    {
                      if ( (v54 & 0xFE) != 0xFC )
                      {
                        ...
                        {
                          j = v87;
                          if ( a4 <= (unsigned __int64)&v8[v87] || (v8[v87] & 0xC0) != 0x80 )
                            break;
                          if ( ++v87 == 6 )
                          {
                            j = 5;
...
LABEL_114:
                ...
                v56 = &v8[v53];
                v57 = 1;
                if ( a4 < (unsigned __int64)v56 )
                {
                  for ( j = 1; a4 > (unsigned __int64)v60; v60 = &v8[++j] )
                  {
                    if ( (*v60 & 0xC0) != 0x80 )
                      break;
                  }
                  if ( (unsigned __int8 *)a4 == v60 )
                  {
LABEL_116:
                    *a3 = v8;
