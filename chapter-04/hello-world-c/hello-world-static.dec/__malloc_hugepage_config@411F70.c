__int64 *__fastcall _malloc_hugepage_config(unsigned __int64 a1, unsigned __int64 *a2, unsigned int *a3)
{
  ...
  int8x16_t v33; // [xsp+8h] [xbp-408h] BYREF
  ...
  *a3 = 0;
  ...
  {
    v19 = 0;
    v20 = _open_nocancel("/proc/meminfo", 0);
    if ( v20 != -1 )
    {
      ...
      if ( (v21 & 0x8000000000000000LL) == 0 )
      {
        ...
        {
          v33.n128_u8[v21] = 0;
          v22 = strstr(&v33, (int8x16_t *)"Hugepagesize:");
          if ( v22 )
            break;
          v23 = strrchr(&v33, 10);
          if ( v23 )
...
LABEL_20:
  ...
  v6 = _open_nocancel("/sys/kernel/mm/hugepages", 0x4000);
  if ( v6 != -1 )
  {
LABEL_3:
    ...
    {
      v8 = (int8x16_t *)((char *)&v33 + v7);
      v9 = &v33;
      while ( 1 )
      {
        v10 = v9;
        v11 = &v9[1].n128_i8[3];
        v9 = (int8x16_t *)((char *)v9 + (unsigned __int16)v9[1].n128_i16[0]);
        if ( v10[1].n128_u8[3] != 46 && !(unsigned int)strncmp(v11, "hugepages-", 10) )
        {
          v12 = v10[1].n128_u8[13];
          v13 = v12 - 48;
          if ( (unsigned __int8)(v12 - 48) <= 9u )
          {
            v14 = &v10[1].n128_u8[14];
            v15 = 0;
            do
            {
              v16 = *v14++;
