        ...
        double a9)
{
  ...
  v15 = *((_QWORD *)v12 + 17);
  v16 = v14 - 1856;
  v17 = (unsigned __int8)_libc_single_threaded;
  v18 = *(_QWORD *)(v15 + 8);
...
LABEL_43:
    v40 = *((_QWORD *)v19 + 27);
    if ( (unsigned __int64)(v40 - (_QWORD)&_io_vtables) > 0x92F )
      IO_vtable_check(a2, a3, a4, a5, a6, a7, a8, a9);
    (*(void (__fastcall **)(int *, __int64))(v40 + 0x18))(stdout, 0xFFFFFFFFLL);
LABEL_12:
    if ( (*v12 & 0x8000) != 0 )
      goto LABEL_18;
    v15 = *((_QWORD *)v12 + 17);
