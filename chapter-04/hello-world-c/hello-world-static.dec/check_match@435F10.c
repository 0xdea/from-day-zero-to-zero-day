        ...
        _DWORD *a11)
{
  ...
  if ( !v11 && v16 != 6 && v17 != 65521 )
    return 0;
  if ( (v17 == 0) & a5 | (-1128 >> v16) & 1 || a6 != a2 && (unsigned int)strcmp((unsigned __int64 *)(a8 + *a6), a1) )
    return 0;
  v18 = *(_QWORD *)(a9 + 904);
  if ( !a3 )
  {
  ...
  {
    v25 = *(_QWORD *)(a3 + 16);
    if ( v25 && (unsigned int)dl_name_match_p(v25, a9) )
      _libc_assert_fail(
  ...
  if ( (v21 != *(_DWORD *)(a3 + 8)
     || (unsigned int)strcmp(*(unsigned __int64 **)(v20 + 24LL * (v19 & 0x7FFF)), *(_QWORD *)a3))
