__int64 __fastcall uw_frame_state_for(_QWORD *a1, unsigned __int64 a2)
{
  __int64 v2; // x2
  __int64 FDE; // x0
  unsigned int *v6; // x23
  ...
  *(_OWORD *)(a2 + 960) = 0u;
  ...
  if ( !v2 )
    return 5;
  FDE = Unwind_Find_FDE(v2 + vcgezd_s64(a1[104]), a1 + 101);
  v6 = (unsigned int *)FDE;
  if ( FDE )
  {
    v7 = (unsigned __int8 *)(FDE + 4 - *(int *)(FDE + 4));
    *(_QWORD *)(a2 + 920) = a1[103];
    v8 = v7 + 9;
    v9 = (char *)&v7[strlen(v7 + 9) + 10];
...
LABEL_25:
          ...
          if ( v15 == -8 && v11 == 1 )
            execute_cfa_program_specialized(v26, v31, (__int64)a1, a2);
          else
            execute_cfa_program_generic(v26, v31, (__int64)a1, a2);
          ...
          if ( *(_BYTE *)(a2 + 962) )
          {
            ...
            {
              read_encoded_value((__int64)a1, v39, v38, &v76);
              v38 += v40;
              a1[100] = v76;
            }
          }
          ...
          {
            v38 = read_encoded_value((__int64)a1, v39, v38, &v76);
            a1[100] = v76;
          }
          v44 = (unsigned __int64)v6 + *v6 + 4;
          if ( *(_QWORD *)(a2 + 936) == -8 && *(_QWORD *)(a2 + 944) == 1 )
            execute_cfa_program_specialized(v38, v44, (__int64)a1, a2);
          else
            execute_cfa_program_generic(v38, v44, (__int64)a1, a2);
          return 0;
        }
        goto LABEL_16;
      }
      ...
      switch ( v25 )
      {
        case 'R':
          ...
          *(_BYTE *)(a2 + 960) = v52;
          break;
        case 'P':
          v9 = read_encoded_value((__int64)a1, *v9, v9 + 1, &v76);
          *(_QWORD *)(a2 + 928) = v76;
          break;
        case 'S':
          *(_BYTE *)(a2 + 963) = 1;
