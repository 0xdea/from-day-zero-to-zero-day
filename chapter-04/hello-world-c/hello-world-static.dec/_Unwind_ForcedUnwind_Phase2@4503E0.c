__int64 __fastcall Unwind_ForcedUnwind_Phase2(_QWORD *a1, _QWORD *a2, __int64 *a3)
{
  __int64 v5; // x23
  __int64 v7; // x24
  ...
  while ( 1 )
  {
    v11 = uw_frame_state_for(a2, (unsigned __int64)v14);
    v10 = v11;
    if ( !v11 || v11 == 5 )
      break;
...
LABEL_4:
    ...
    ++v5;
    ((void (__fastcall *)(_QWORD *, _BYTE *))uw_update_context)(a2, v14);
  }
  if ( v11 != 5 )
  {
