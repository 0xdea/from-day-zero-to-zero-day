        ...
        ...)
{
  ...
  char v41; // [xsp+F0h] [xbp+50h] BYREF
  ...
  char v48; // [xsp+130h] [xbp+90h] BYREF
  ...
  for ( i = 0; ; i = v23 )
  {
    ...
    do
    {
      if ( v19 == 37 && v20[1] == 115 )
        break;
      v20 = (unsigned __int8 *)strchrnul(v20 + 1, 37);
      v19 = *v20;
    }
    while ( *v20 );
    if ( v12 == 37 && v9[1] == 115 )
...
LABEL_14:
        ...
        v31 = (dl_pagesize + 4 + v15) & -dl_pagesize;
        stack = (_DWORD *)mmap64(0, v31, 3, 34, 0xFFFFFFFFLL, 0);
        v32 = stack;
        if ( stack != (_DWORD *)-1LL )
        {
          ...
          *(_BYTE *)(v36 + iov_len) = 0;
          _set_vma_name(v32, v31, " glibc: fatal");
          stack = (_DWORD *)_aarch64_swp8_acq(v32, &_abort_msg);
          if ( stack )
            stack = (_DWORD *)munmap(stack, (unsigned int)*stack);
        }
LABEL_25:
        abort((__int64)stack, v11, (__int64)v10, v13);
      }
    }
    else
    {
