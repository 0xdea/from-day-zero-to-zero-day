        ...
        double a15)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v24 )
      return v23;
    v25 = v23 + 2;
    maybe_split_for_insert_isra_0(*v15, v22, v21, v20, v19, 0);
    if ( v24 < 0 )
    {
      v25 = v23 + 1;
      v19 = v20;
      ...
      {
LABEL_11:
        v27 = malloc(0x18u, a8, a9, a10, a11, a12, a13, a14, a15, v26, a3, a4, a5, a6, a7);
        v23 = (_QWORD *)v27;
        if ( !v27 )
          return 0;
        *v25 = v27 | *v25 & 1;
        ...
        *(_OWORD *)(v27 + 8) = xmmword_45A920;
        if ( v15 != v25 )
        {
          maybe_split_for_insert_isra_0(*v25, v15, (unsigned __int64 *)v22, v24, v20, 1);
          return v23;
        }
        return v23;
      }
  ...
  v29 = malloc(0x18u, a8, a9, a10, a11, a12, a13, a14, a15, v16, a3, a4, a5, a6, a7);
  v30 = v29;
  if ( !v29 )
    return 0;
  *v15 = v29 | *v15 & 1;
