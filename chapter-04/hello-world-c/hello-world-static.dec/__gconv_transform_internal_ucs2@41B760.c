        ...
        unsigned int a8)
{
  ...
  __int64 (__fastcall *v92)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD); // [xsp+10h] [xbp-70h]
...
LABEL_153:
    ...
    **(_QWORD **)(a2 + 32) = 0;
    if ( (*(_DWORD *)(a2 + 16) & 1) == 0 )
      return ((__int64 (__fastcall *)(__int64, __int64, _QWORD, _QWORD, _QWORD, _QWORD *, _QWORD))v20)(
               a1 + 104,
               v13,
               0,
               0,
  ...
  if ( a8 )
  {
    ...
    if ( v26 )
    {
      ...
      if ( a4 >= v27 - v30 + 4 )
      {
        ...
        if ( v9 >= (unsigned __int64)(v25 + 1) )
        {
          do
          {
            v33 = v30++;
            v108 = v32;
            v34 = v30 <= 3 && a4 > (unsigned __int64)v32;
...
LABEL_152:
          ...
          v66 = (unsigned int *)*((_QWORD *)v18 + 4);
          v67 = 0;
          if ( v65 )
          {
            do
            {
              *((_BYTE *)v66 + v67 + 4) = *((_BYTE *)v64 + v67);
              ++v67;
            }
            while ( v65 != v67 );
            v16 = v65;
...
LABEL_101:
    ...
    do
    {
      v56 = (unsigned int *)v22 + 1;
      if ( a4 < (unsigned __int64)v22 + 4 )
      {
LABEL_99:
        v8 = v108;
        v22 = v25;
...
LABEL_140:
    v86 = v12;
    v90 = v23;
    v92 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))v20;
    v94 = v19;
    v96 = v13;
    v98 = v15;
    v100 = v33;
