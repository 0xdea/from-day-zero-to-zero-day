__int64 __fastcall uw_init_context_1(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v3; // x30
  __int64 v7; // x0
  __int64 v8; // x1
  ...
  *(_QWORD *)(a1 + 832) = 0x4000000000000000LL;
  v7 = uw_frame_state_for((_QWORD *)a1, (unsigned __int64)v14);
  if ( (_DWORD)v7 )
    goto LABEL_9;
  v10 = dwarf_reg_size_table;
...
LABEL_9:
  ...
  *(_QWORD *)(a1 + 248) = &v13;
  ...
  v15 = 0;
  v16 = 31;
  result = ((__int64 (__fastcall *)(__int64, _BYTE *))uw_update_context_1)(a1, v14);
  *(_QWORD *)(a1 + 792) = a3;
  return result;
}
