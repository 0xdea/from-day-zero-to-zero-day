        ...
        long double a13)
{
  ...
  const char *v162; // [xsp+30148h] [xbp+100h]
...
LABEL_60:
        ...
        if ( v69 >= 0x400uLL )
          v127 = 0;
        v71 = (const char *)sub_4336E0(v23, v43, v126);
        if ( !*v71 )
        {
          v28 = *v41;
          if ( *v41 == 2147483645 )
...
LABEL_38:
  ...
  if ( v54 >= 0x400uLL )
    v133 = 0;
  v25 = (const char *)sub_4336E0(v23, v43, v132);
  if ( !*v25 )
  {
    if ( (*v147 & 1) == 0 )
      goto LABEL_52;
