        ...
        unsigned __int64 a6)
{
  ...
  int v47; // [xsp+F4h] [xbp+74h]
  __int64 v48; // [xsp+100h] [xbp+80h]
  ...
  __int64 v56; // [xsp+140h] [xbp+C0h] BYREF
...
LABEL_15:
    ...
    if ( (dword_496770 & 0x40) != 0 )
    {
      if ( a1 )
      {
        ...
        {
LABEL_18:
          v56 = sub_433860(a1, a2);
          v20 = v56;
          if ( !v56 )
            goto LABEL_24;
LABEL_19:
          LODWORD(v21) = sub_432B50(v20, (__int64)v58, &v55, 1);
          if ( (_DWORD)v21 != -1 )
          {
            if ( (a5 & 0x10000000) != 0 )
              a1 = 0;
LABEL_22:
            v57[0] = qword_48F7A8;
            return sub_434280(a2, v21, (__int64)v58, v56, a1, a3, a5, (__int64)v57, a6);
          }
          sub_40C1A0(v20);
LABEL_24:
          if ( (a5 & 0x10000000) == 0 )
...
LABEL_31:
        ...
        v30 = (__int64 *)a1;
        v49 = 0;
        for ( i = sub_433D80(v30, v30 + 110, 15, "RPATH"); ; i = sub_433D80(v30, v30 + 110, 15, "RPATH") )
        {
          if ( (i & 1) != 0 )
          {
            LODWORD(v21) = sub_433030((__int64)a2, v51, a5, v30 + 110, &v56, (__int64)v58, a1, &v55);
            if ( (_DWORD)v21 != -1 )
              goto LABEL_34;
            v49 |= v52 == v30;
          }
...
LABEL_32:
          ...
          {
LABEL_33:
            LODWORD(v21) = sub_433030((__int64)a2, v51, a5, &qword_48FAF8, &v56, (__int64)v58, a1, &v55);
            if ( (_DWORD)v21 != -1 )
              goto LABEL_34;
          }
LABEL_41:
          ...
          v28 = (__int64 *)a1;
LABEL_74:
          v29 = sub_433030((__int64)a2, v51, a5, v27, &v56, (__int64)v58, (__int64)v28, &v55);
          v21 = v29;
          if ( v29 == -1 )
          {
LABEL_42:
            v56 = 0;
            if ( (a5 & 0x4000000) != 0 && dword_491570 || dword_496810 || (v23 = sub_43A590(a2)) == 0 )
            {
LABEL_91:
              v36 = (__int64 *)a1;
              if ( a1 )
...
LABEL_67:
        ...
        if ( (v26 & 1) != 0 )
        {
          if ( a1 )
            ...
            v42 = (__int64)v52;
          v21 = (unsigned int)sub_433030((__int64)a2, v51, a5, v52 + 110, &v56, (__int64)v58, v42, &v55);
          if ( (a5 & 0x8000000) == 0 )
            goto LABEL_116;
          if ( (_DWORD)v21 != -1 )
            goto LABEL_34;
...
LABEL_93:
              if ( qword_48FB08 != -1 )
              {
                LODWORD(v21) = sub_433030((__int64)a2, v51, a5, &qword_48FB08, &v56, (__int64)v58, (__int64)v36, &v55);
                if ( (dword_496770 & 1) == 0 )
                {
LABEL_50:
                  if ( v47 )
...
LABEL_92:
        ...
        if ( a1 )
          ...
          v43 = (__int64)v52;
        v21 = (unsigned int)sub_433030((__int64)a2, v51, a5, v57, &v56, (__int64)v58, v43, &v55);
LABEL_116:
        if ( (_DWORD)v21 != -1 )
          goto LABEL_34;
        goto LABEL_71;
