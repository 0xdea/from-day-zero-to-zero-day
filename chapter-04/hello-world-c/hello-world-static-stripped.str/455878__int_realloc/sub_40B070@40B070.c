        ...
        double a12)
{
  ...
  double v75; // d6
  double v76; // d7
  unsigned __int64 v77; // [xsp+68h] [xbp+68h]
...
LABEL_11:
    v24 = v16 - a4;
    v25 = 4LL * (a1 != (_QWORD *)&dword_490670);
    if ( v16 - a4 > 0x1F )
    {
      v41 = a2 + a4;
      if ( (v23[1697] & 1) != 0 )
  ...
  if ( a1[12] == v18 )
  {
    ...
    if ( a4 + 32 <= v17 )
    {
      v42 = v13 & 7 | (4LL * (a1 != (_QWORD *)&dword_490670));
      v43 = byte_4966A1;
      *(_QWORD *)(a2 + 8) = v42 | a4;
      a1[12] = a2 + a4;
...
LABEL_33:
  ...
  if ( (byte_4966A1 & 1) != 0 )
  {
    ...
    {
      v31 = a2 + 16;
      v77 = (*(_QWORD *)(a2 + 8) & 0xFFFFFFFFFFFFFFF8LL) - 16;
      sub_411CC0(a2 + 16, v77);
      v32 = v77;
      if ( (byte_4966A1 & 1) != 0 )
      {
        _X0 = v29;
...
LABEL_38:
  v69 = sub_41F250(
          ...
          "_int_realloc",
          *(double *)&a5);
  return sub_40B410(v63, v64, v65, v66, v69, v70, v71, v72, v73, v74, v75, v76, v67, v68);
}
