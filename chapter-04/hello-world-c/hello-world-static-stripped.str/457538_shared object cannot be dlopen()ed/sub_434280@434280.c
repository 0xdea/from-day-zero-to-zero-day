        ...
        __int64 a9)
{
  ...
  unsigned int v170; // [xsp+100ECh] [xbp+BCh]
  __int64 *v171; // [xsp+100F0h] [xbp+C0h]
  int v172; // [xsp+100F8h] [xbp+C8h]
  unsigned int v173; // [xsp+100FCh] [xbp+CCh]
...
LABEL_4:
    ...
    v17 = (__int64 *)sub_437850(a4, a1, a6, a5, (unsigned int)a7, a9);
    if ( !v17 )
    {
...
LABEL_26:
  ...
  sub_410CD0(a2);
  sub_40C1A0(a4);
  sub_433530((_QWORD *)v17[7], (__int64)a1);
  return v17;
}
