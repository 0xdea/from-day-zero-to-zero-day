  ...
  *v33 = 0;
  ...
  if ( v41 )
  {
    ...
    if ( (*((_BYTE *)v39 + 870) & 0x20) != 0 )
      v42 = *v39;
    sub_433BD0(v39 + 127, *(_QWORD *)(v39[13] + 8) + *(_QWORD *)(v41 + 8) + v42, v39, "RUNPATH");
    *((_DWORD *)v39 + 256) = 0;
    v39[110] = -1;
  }
  else
  {
    ...
    if ( v48 )
    {
      ...
      if ( (*((_BYTE *)v39 + 870) & 0x20) != 0 )
        v49 = *v39;
      sub_433BD0(v39 + 110, *(_QWORD *)(v39[13] + 8) + *(_QWORD *)(v48 + 8) + v49, v39, "RPATH");
      *((_DWORD *)v39 + 222) = 0;
    }
    else
    {
...
LABEL_38:
  ...
  sub_433970(v64, qword_48FAF8, ":;", a2, 0, v39);
  result = qword_48FAF8;
