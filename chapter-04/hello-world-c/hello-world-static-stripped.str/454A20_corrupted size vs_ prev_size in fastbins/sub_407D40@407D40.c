__int64 *__fastcall sub_407D40(__int64 a1)
{
  __int64 v1; // x20
  __int64 v2; // x21
  __int64 v3; // x22
  ...
  *(_DWORD *)(a1 + 8) = 0;
  ...
  do
  {
    result = (__int64 *)sub_44D5F0(0, v6);
    if ( !result )
      goto LABEL_3;
    v26 = v1;
    v16 = result;
    ...
    while ( 1 )
    {
      ...
      if ( (v17 & 1) == 0 )
      {
        ...
        sub_407C70(v16, v8, v9, v10, v11, v12, v13, v14, v15);
        v23 = (__int64 *)(v21 ^ v20);
      }
...
LABEL_11:
    ...
    result = *(__int64 **)(v5 + 16);
    *(_QWORD *)(v5 + 16) = v16;
    result[3] = (__int64)v16;
    if ( v18 > 0x3FF )
    {
      v16[4] = 0;
      v16[5] = 0;
