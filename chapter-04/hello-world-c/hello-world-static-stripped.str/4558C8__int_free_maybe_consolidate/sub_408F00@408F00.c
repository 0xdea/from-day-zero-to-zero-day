__int64 *__fastcall sub_408F00(_DWORD *a1, long double a2)
{
  __int64 v2; // x21
  __int64 v3; // x22
  __int64 v4; // x23
  ...
  double v49; // d6
  double v50; // d7
  unsigned __int64 v51; // [xsp+8h] [xbp-18h]
  char v52; // [xsp+17h] [xbp-9h] BYREF
  __int64 v53; // [xsp+18h] [xbp-8h]
  __int64 v54; // [xsp+40h] [xbp+20h]
  __int64 v55; // [xsp+48h] [xbp+28h]
  __int64 v56; // [xsp+50h] [xbp+30h]
  _QWORD *v57; // [xsp+58h] [xbp+38h]
  __int64 v58; // [xsp+60h] [xbp+40h]
  unsigned __int64 v59; // [xsp+68h] [xbp+48h]
  __int64 v60; // [xsp+70h] [xbp+50h]
  __int64 v61; // [xsp+78h] [xbp+58h]
...
LABEL_27:
        ...
        if ( dword_491570 )
          goto LABEL_49;
        v38 = sub_410EE0("/proc/sys/vm/overcommit_memory", 0x80000, v51);
        LODWORD(v9) = v38;
        if ( (v38 & 0x80000000) != 0 )
        {
          v39 = dword_490660;
...
LABEL_61:
    ...
    return sub_409394(v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v50);
  }
  return result;
}
