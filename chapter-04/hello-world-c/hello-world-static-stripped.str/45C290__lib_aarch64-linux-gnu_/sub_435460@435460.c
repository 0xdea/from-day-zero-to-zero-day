__int64 *__fastcall sub_435460(__int64 a1, char *a2, unsigned int a3, int a4, int a5, unsigned __int64 a6)
{
...
LABEL_25:
                ...
                v32 = sub_42F380(a2);
                v33 = v32;
                if ( !v32 || (v34 = sub_437850(v32, a2, a3, a1, (unsigned int)a5, a6), (v13 = (__int64 *)v34) == 0) )
                {
                  sub_40C1A0(v33);
