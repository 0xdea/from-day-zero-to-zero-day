__int64 *__fastcall sub_4407D0(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  char v75; // w1
  __int64 v78; // x0
  long double v79; // [xsp+0h] [xbp-60h]
  ...
  __int64 v89; // [xsp+0h] [xbp-60h]
  long double v90; // [xsp+10h] [xbp-50h]
  __int64 v91; // [xsp+10h] [xbp-50h]
  _BYTE v93[7]; // [xsp+35h] [xbp-2Bh] BYREF
  _BYTE v94[12]; // [xsp+3Ch] [xbp-24h] BYREF
  _BYTE v95[3]; // [xsp+48h] [xbp-18h] BYREF
  _BYTE v96[13]; // [xsp+4Bh] [xbp-15h] BYREF
  __int64 v97; // [xsp+58h] [xbp-8h] BYREF
  __int64 v98; // [xsp+C0h] [xbp+60h]
  ...
  if ( (v6 & 1) == 0 )
  {
    ...
    v25 = sub_4244D0(*(_QWORD *)&v13 & 0xFFFFFFFFFFFFFLL, &v97, 16, v11 == 65);
    v26 = v25;
    if ( v25 > (unsigned __int64)v96 )
      v26 = ifunc_40DE70(v96, 48, v25 - (_QWORD)v96);
...
LABEL_78:
  ...
  v79 = *(long double *)v8;
  v14 = *(_QWORD *)(v8 + 8) >> 63;
  if ( (unsigned int)sub_44D7B0(v79, v79) )
  {
    v15 = "NAN";
    if ( (*(_WORD *)(*(_QWORD *)(_ReadStatusReg(TPIDR_EL0) + 72) + 2LL * v11) & 0x100) == 0 )
      v15 = "nan";
LABEL_6:
  ...
  *(_QWORD *)&v90 = *(_QWORD *)&v79;
  *((_QWORD *)&v90 + 1) = *((_QWORD *)&v79 + 1) & 0x7FFFFFFFFFFFFFFFLL;
  if ( (unsigned int)sub_44D7B0(v90, *(long double *)&xmmword_45A930)
    || (int)sub_44D650(v90, *(long double *)&xmmword_45A930) <= 0 )
  {
    v23 = &v97;
    v91 = *((_QWORD *)&v79 + 1) & 0xFFFFFFFFFFFFLL | *(_QWORD *)&v79;
    v24 = v91 == 0;
    v30 = sub_4244D0(*(_QWORD *)&v79, &v97, 16, v11 == 65);
    v31 = v30;
    if ( v30 > (unsigned __int64)v95 )
      v31 = ifunc_40DE70(v95, 48, v30 - (_QWORD)v95);
    v32 = sub_4244D0(*((_QWORD *)&v79 + 1) & 0xFFFFFFFFFFFFLL, v31, 16, *(_DWORD *)(a3 + 8) == 65);
    v26 = v32;
    if ( v32 > (unsigned __int64)v94 )
      v26 = ifunc_40DE70(v94, 48, v32 - (_QWORD)v94);
    v27 = HIWORD(*((_QWORD *)&v79 + 1)) & 0x7FFFLL;
    v28 = ((*((_QWORD *)&v79 + 1) & 0x7FFF000000000000LL) != 0) + 48;
    if ( (_DWORD)v27 )
    {
      if ( (HIWORD(v79) & 0x7FFFu) <= 0x3FFE )
      {
...
LABEL_155:
              v86 = v26;
              v50 = sub_4244D0((int)v29, v93, 10, 0);
              v51 = v86;
              v52 = 4;
LABEL_82:
              v53 = *(_WORD *)(a3 + 12);
              v54 = v10 - (v9 + v52 + (unsigned int)&v93[-v50]);
              if ( v9 <= 0 )
              {
                v55 = v54 - 2;
                if ( (v53 & 8) != 0 )
...
LABEL_93:
                    ...
                    sub_43E650(a1, v50, (unsigned __int64)&v93[-v50]);
