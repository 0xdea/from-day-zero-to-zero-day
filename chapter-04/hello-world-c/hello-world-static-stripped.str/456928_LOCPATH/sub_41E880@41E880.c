char **__fastcall sub_41E880(int a1, char *a2)
{
  ...
  _QWORD v42[13]; // [xsp+38h] [xbp-D8h] BYREF
  _QWORD v43[13]; // [xsp+A0h] [xbp-70h] BYREF
  ...
  else
  {
    ...
    if ( (_DWORD)v10 != 6 )
    {
      ...
      if ( v2 == "C" || (v43[0] = sub_42F380(v2)) != 0 )
      {
        v2 = (char *)sub_41E580((unsigned int)v10, v43);
        if ( v2 )
        {
          if ( v12 )
          {
...
LABEL_69:
      ...
      if ( v17 != (char **)off_4918D0[0] )
      {
        if ( off_4918D0[0] != "C" )
          sub_40C1A0(off_4918D0[0]);
        off_4918D0[0] = (char *)v17;
      }
      v8 = v51;
      v9 = v52;
      LODWORD(qword_496940) = qword_496940 + 1;
