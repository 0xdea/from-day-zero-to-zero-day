__int64 __fastcall sub_4141A0(__int64 result)
{
  int v1; // w10
  __int64 v2; // x11
  int v3; // w12
  ...
  while ( 1 )
  {
    ...
    if ( !v5 )
    {
      ...
      return sub_438540("WARNING: ld.so: invalid GLIBC_TUNABLES `%s': ignored.\n", (const char *)result);
    }
LABEL_14:
    v9 = v6 + 1;
    if ( v4 != 58 )
